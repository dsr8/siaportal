...
class Visitor_visa_usa extends BaseController
{


public function edit_visitor_visa_usa($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_visa_usa/edit_visitor_visa_usa',$data);
}
}
///-------------------

public function full_visitor_visa_usa($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_visa_usa/full_view_visitor_visa_usa',$data);
}
