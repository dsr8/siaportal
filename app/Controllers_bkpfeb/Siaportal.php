...
@mail('ds@siaimmigration.com,mj@siaimmigration.com,no-reply@siaimmigration.com',$subject,$message,$headers);
...
//$this->edit_bc_pnp_int_grd($category,$id);
		...
		$url = 'BC_pnp_int_grd_exp_entery/edit_bc_pnp_int_grd_exp_entery/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'PGWP_application_inland/edit_PGWP_application_inland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Temporary_resident_visa_na/edit_temporary_resident_visa_na/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Immigration_application_na/edit_immigration_application_na/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Work_permit_LMIA_inland/edit_Work_permit_LMIA_inland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Work_permit_LMIA_outland/edit_Work_permit_LMIA_outland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'LMIA_exempt_na/edit_LMIA_exempt_na/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Other_open_work_permit_new_application/edit_other_open_work_permit_new_application/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Other_open_work_permit_extention/edit_other_open_work_permit_extention/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Study_permit_extension_inland/edit_study_permit_extension_inland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'PGWP_extension_inland/edit_PGWP_extension_inland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Super_visa_outland/edit_super_visa_outland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Citizenship_certi_application_adult/edit_citizenship_certi_application_adult/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Citizenship_certi_application_minor/edit_citizenship_certi_application_minor/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Passport_na/edit_passport_na/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Common_law_part_sps_inland/edit_common_law_part_sps_inland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'CAIPS_NOTES_CAIPS/edit_caips_notes_caips/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'CAIPS_NOTES_GCMS/edit_caips_notes_gcms/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'DLI_NUMBER_CHANGE/edit_dli_number_change/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'BC_PNP_tech_pilot_skill_worker/edit_bc_pnp_tech_pilot_skill_worker/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'BC_PNP_semi_skilled_long_haul_truck/edit_bc_pnp_semi_skilled_long_haul_truck/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Bridging_open_wp_na/edit_bridging_open_wp_na/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'BC_pnp_int_pg_exp_entery/edit_bc_pnp_int_pg_exp_entery/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Worker_spousal_open_wp_outland/edit_worker_spousal_open_wp_outland/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
		...
		$url = 'Co_op_wp/edit_co_op_wp/'.$category.'/'.$id.'/'.$sid.'';
					echo'
					<script>					
					window.location.href = "'.base_url().'/'.$url.'";
					</script>
