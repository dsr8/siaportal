...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Study permit application inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Study_permit_application_inland/edit_study_permit_application_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        <?php } else if ($cpm['0']['application_status']==511) { ?> 
       
        <option value="512">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==512) { ?> 
        <option value="513">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==513) { ?> 
...
$tm= $acc['0']['tolat_pay_plan'];
 ...
 <input type="radio" name="retainer_app" id="retainer_app"    value="yes" /> Yes
  <input type="radio" name="retainer_app" id="retainer_app"    value="no" /> no
</div>

            <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Application Govt fee will be paid from </label></br>
 <input type="radio" name="govt_fee" id="govt_fee"    value="td_sia" /> Td Sia
  <input type="radio" name="govt_fee" id="govt_fee"    value="Client_own" /> Client own
  <input type="radio" name="govt_fee" id="govt_fee"    value="tbd" /> Tbd
</div>
 ...
 <input type="radio" name="pay_plan" id="pay_plan"   value="yes" /> Yes
 <input type="radio" name="pay_plan" id="pay_plan"    value="no" /> no.
 ...
 <input type="radio" name="est_app" id="est_app"    value="yes" /> Yes
 <input type="radio" name="est_app" id="est_app"    value="no" /> no </br> 
...
<!---->
 ...
 <input type="radio" name="pay_one" id="pay_one"    value="Invoice_sent_not_yet_paid" /> Invoice sent,not yet paid
  <input type="radio" name="pay_one" id="pay_one"    value="paid" /> paid
</div>
...
<div class="form-group">
 ...
 <input type="radio" name="pay_two" id="pay_two"    value="Invoice_sent_not_yet_paid" /> Invoice sent,not yet paid
  <input type="radio" name="pay_two" id="pay_two"    value="paid" /> paid
</div>
...
<div class="form-group">
 ...
 <input type="radio" name="pay_three" id="pay_three"   value="Invoice_sent_not_yet_paid" /> Invoice sent,not yet paid
  <input type="radio" name="pay_three" id="pay_three"    value="paid" /> paid
</div>
...
<div class="form-group">
 ...
 <input type="radio" name="pay_four" id="pay_four"    value="Invoice_sent_not_yet_paid" /> Invoice sent,not yet paid
  <input type="radio" name="pay_four" id="pay_four"    value="paid" /> paid
</div>
...
<div class="form-group">
 ...
 <input type="radio" name="pay_five" id="pay_five"    value="Invoice_sent_not_yet_paid" /> Invoice sent,not yet paid
  <input type="radio" name="pay_five" id="pay_five"   value="paid" /> paid
</div>
...
<div class="form-group">
 ...
 <input type="radio" name="pay_sex" id="pay_six"    value="Invoice_sent_not_yet_paid" /> Invoice sent,not yet paid
  <input type="radio" name="pay_sex" id="pay_sex"   value="paid" /> paid
</div>
