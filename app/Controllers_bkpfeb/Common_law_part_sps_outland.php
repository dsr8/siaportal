...
class Common_law_part_sps_outland extends BaseController
{


public function edit_common_law_part_sps_outland($category,$id,$sid){
...
public function full_common_law_part_sps_outland($category,$id,$sid){
