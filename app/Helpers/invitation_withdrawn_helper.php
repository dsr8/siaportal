...
function invitation_withdrawn_team_mail($iggd,$name,$invit_withdrawn_reason){
...
//function invitation_withdrawn_client_mail_msg($name,$tname,$tmobile,$cmobile,$reason,$email){}
