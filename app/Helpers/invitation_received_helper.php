...
function invitation_received_team_mail($iggd,$name,$invitation_date_tantative,$invitation_date_final){
...
//function invitation_received_client_mail_msg($name,$tname,$tmobile,$cmobile,$email){}
