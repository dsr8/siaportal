...
function advertisement_started_team_mail($iggd,$ad_job_start_date,$ad_job_end_date,$ad_il_start_date,$ad_il_end_date,$ad_ki_start_date,$ad_ki_end_date,$ad_ca_start_date,$ad_ca_end_date,$ad_oa_start_date,$ad_oa_end_date,$name){
...
//function advertisement_started_client_mail_sms($name,$fname,$tmobile,$cmobile,$email){}
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>We wish to inform you that you employer portal is active now. 
 Advertisements has been posted and running successfully.</td>
                            </tr>
