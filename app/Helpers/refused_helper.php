...
function refuse_mail_team($iggd,$name,$refused_note,$refusal_letter){
...
//function refused_mail_client($name,$tname,$cmobile,$email,$refusal_letter){}
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>We regret to inform you that your application has been refused. We can still make efforts to reapply your application if you are interested. Please find attached correspondence regarding decisions
</td>
                            </tr>
