...
function interview_ADR_requested_team_mail($iggd,$name,$date_int_req_rec,$date_int_sent_client){
...
//function interview_ADR_requested_client_mail_sms($name,$tname,$tmobile,$cmobile,$email){}
