<?php
function LMIA_number_received_team_mail($iggd,$name,$lmia_rec_date,$lmia_number){
	
	$From="Sia Immigration";
				$ee = session()->get('email');
           $emaill=$ee;

					$subject  = "LMIA Number Received id-".$iggd." Name-".$name."";
           ...
           $headers .= 'From:  ' . $From . ' <' . $emaill .'>' . " \r\n" .
            ...
            'X-Mailer: PHP/' . phpversion();
				...
				$message .= 'LMIA Number Received Date : ' .$lmia_rec_date.'<br>';
				$message .= 'LMIA Number : ' .$lmia_number.'<br>';
...
//function LMIA_number_received_client_mail_sms($name,$fname,$tmobile,$cmobile,$email){}
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>Your LMIA Number Received.</td>
                            </tr>
