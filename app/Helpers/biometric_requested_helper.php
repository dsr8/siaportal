...
function biometric_requested_team_mail($iggd,$name,$date_bio_reciv,$date_bio_sen){
...
$From="Sia Immigration";$ee = session()->get('email');
   ...
   $emaill="mkj@siaimmigration.com";
        ...
        $message .= 'Date of Biometric sent to client : ' .$date_bio_sen.'<br>';
...
//function biometric_requested_client_mail_sms($name,$tname,$tmobile,$cmobile,$email){}
