<?php
function application_submitted_mail_team($iggd,$name,$fee,$app_sub_date,$mode_client_payment,$date_of_payment_recive,$confirm_with,$amount,$l1,$l2){
	...
	$From="Sia Immigration";
           ...
           $headers .= 'From:  ' . $From . ' <' . $emaill .'>' . " \r\n" .
            ...
            'X-Mailer: PHP/' . phpversion();
				...
				$message .= 'Fee Receipt Upload : <a href="https://canada.siaimmigration.com/assets/resume/'.$l1.'">Fee Receipt Upload</a><br>';
				$message .= 'Submission Confirmation Upload : <a href="https://canada.siaimmigration.com/assets/resume/'.$l2.'">Submission Confirmation Upload</a><br>';
...
//function application_submitted_mail_to_client($name,$fname,$tmobile,$cmobile,$email){}
