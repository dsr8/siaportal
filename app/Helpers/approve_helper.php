<?php
function approve_mail_team($iggd,$name,$approve_note,$date_work_permit,$approval_letter){
	...
	$From="Sia Immigration";
           ...
           $headers .= 'From:  ' . $From . ' <' . $emaill .'>' . " \r\n" .
            ...
            'X-Mailer: PHP/' . phpversion();
					...
					$message .= 'Date Of Approval : ' .$date_work_permit.'<br>';
					$message .= 'Approve Letter  : <a href="https://canada.siaimmigration.com/assets/resume/'.$approval_letter.'">Approve Letter </a><br>';
...
//function approve_mail_client($name,$fname,$cmobile,$email,$iggd){}
