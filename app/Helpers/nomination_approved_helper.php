<?php
function nomination_approved_team_mail($iggd,$name){
...
//function nomination_approved($name,$tname,$tmobile,$cmobile,$email){}
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>Congratulations!  Your  Nomination has been approved . Our team will contact you soon to start next steps for your permanent residency application.</td>
                            </tr>
