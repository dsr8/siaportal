...
class Common_law_part_sps_inland extends BaseController
{



public function edit_common_law_part_sps_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/common_law_part_sps_inland/edit_common_law_part_sps_inland',$data);
}
}
///-------------------
...
public function edit_common_law_part_sps_inland_new($category,$id,$sid){
...
public function full_common_law_part_sps_inland($category,$id,$sid){
