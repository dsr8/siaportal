...
class Francophone_work_permit extends BaseController
{

public function edit_francophone_work_permit_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/francophone_work_permit/edit_francophone_work_permit_new',$data);
}
}
///-------------------


public function full_francophone_work_permit($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/francophone_work_permit/full_view_francophone_work_permit',$data);
}
