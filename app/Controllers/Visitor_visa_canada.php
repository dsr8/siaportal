...
class Visitor_visa_canada extends BaseController
{


public function edit_visitor_visa_canada($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_visa_canada/edit_visitor_visa_canada',$data);
}
}
///-------------------

//////////new start
public function edit_visitor_visa_canada_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_visa_canada/edit_visitor_visa_canada_new',$data);
}
}
///-------------------
...
public function full_visitor_visa_canada($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_visa_canada/full_view_visitor_visa_canada',$data);
}
