...
class Intl_stu_spousal_open_wp_inland extends BaseController
{
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/intl_stu_spousal_open_wp_inland/edit_intl_stu_spousal_open_wp_inland',$data);
}
}
///-------------------

//////////new start
public function edit_intl_stu_spousal_open_wp_inland_new($category,$id,$sid){
if ($this->request->getMethod()=='post'){
 if($img = $this->request->getFile('fee_receipt'))
        {
        //	echo"hih";
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/intl_stu_spousal_open_wp_inland/edit_intl_stu_spousal_open_wp_inland_new',$data);
}
}
///-------------------
...
public function full_intl_stu_spousal_open_wp_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/intl_stu_spousal_open_wp_inland/full_view_intl_stu_spousal_open_wp_inland',$data);
}
