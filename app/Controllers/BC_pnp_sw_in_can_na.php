...
class BC_pnp_sw_in_can_na extends BaseController
{


public function edit_bc_pnp_sw_in_can_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bc_pnp_sw_in_can_na/edit_bc_pnp_sw_in_can_na',$data);
}
}
///-------------------

/////////////new start
public function edit_bc_pnp_sw_in_can_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bc_pnp_sw_in_can_na/edit_bc_pnp_sw_in_can_na_new',$data);
}
}
///-------------------
...
public function full_bc_pnp_sw_in_can_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_sw_in_can_na/full_view_bc_pnp_sw_in_can_na',$data);
}
