...
class Conjugal_sponsorship extends BaseController
{

public function edit_conjugal_sponsorship_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/conjugal_sponsorship/edit_conjugal_sponsorship_new',$data);
}
}
///-------------------


public function full_conjugal_sponsorship($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/conjugal_sponsorship/full_view_conjugal_sponsorship',$data);
}
