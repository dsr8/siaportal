...
class BC_pnp_int_grd extends BaseController
{
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_int_grd/edit_bc_pnp_int_grd',$data);
}
}
///-------------------

public function edit_bc_pnp_int_grd_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_int_grd/edit_bc_pnp_int_grd_new',$data);
}
}
///-------------------
...
public function full_bc_pnp_int_grd($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_int_grd/full_view_bc_pnp_int_grd',$data);
