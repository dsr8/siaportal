...
class Work_permit_LMIA_outland extends BaseController
{


public function edit_Work_permit_LMIA_outland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Work_permit_LMIA_outland/edit_work_permit_LMIA_outland',$data);
}
}
///-------------------

//////////////new start
public function edit_Work_permit_LMIA_outland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Work_permit_LMIA_outland/edit_work_permit_LMIA_outland_new',$data);
}
}
///-------------------
...
public function full_Work_permit_LMIA_outland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/Work_permit_LMIA_outland/full_view_work_permit_LMIA_outland',$data);
}
