...
class Immigration_application_na extends BaseController
{


public function edit_immigration_application_na($category,$id,$sid){
...
//exit();
   ...
   'app_sub_date'=>$this->request->getPost('app_sub_date'),
    'if_any_note'=>$this->request->getPost('if_any_note'),
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/immigration_application_na/edit_immigration_application_na',$data);
}
}
///-------------------
...
public function edit_immigration_application_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/immigration_application_na/edit_immigration_application_na_new',$data);
}
}
///-------------------
...
public function full_immigration_application_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/immigration_application_na/full_view_immigration_application_na',$data);
}
