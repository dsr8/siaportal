...
class Visitor_record_na extends BaseController
{

public function edit_visitor_record_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_record_na/edit_visitor_record_na_new',$data);
}
}
///-------------------


public function full_visitor_record_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/visitor_record_na/full_view_visitor_record_na',$data);
}
