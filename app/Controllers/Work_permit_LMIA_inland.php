...
class Work_permit_LMIA_inland extends BaseController
{


public function edit_Work_permit_LMIA_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Work_permit_LMIA_inland/edit_work_permit_LMIA_inland',$data);
}
}
///-------------------

//////////////////new start
public function edit_Work_permit_LMIA_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Work_permit_LMIA_inland/edit_work_permit_LMIA_inland_new',$data);
}
}
///-------------------
...
public function full_work_permit_LMIA_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/Work_permit_LMIA_inland/full_view_work_permit_LMIA_inland',$data);
