...
class DLI_NUMBER_CHANGE extends BaseController
{


public function edit_dli_number_change($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/dli_number_change/edit_dli_number_change',$data);
}
}
///-------------------
...
public function edit_dli_number_change_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/dli_number_change/edit_dli_number_change_new',$data);
}
}
///-------------------
...
public function full_dli_number_change($category,$id,$sid){
