...
class Canadian_exp_class extends BaseController
{


public function edit_canadian_exp_class($category,$id,$sid){
...
//exit();
   ...
   'free_text'=>$this->request->getPost('free_text'),
    ...
    'gc_password'=>$this->request->getPost('gc_password'),
     ...
     'CRS_score'=>$this->request->getPost('CRS_score'),
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/canadian_exp_class/edit_canadian_exp_class',$data);
}
}
///-------------------

//////////new start
public function edit_canadian_exp_class_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/canadian_exp_class/edit_canadian_exp_class_new',$data);
}
}
///-------------------
...
public function full_canadian_exp_class($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/canadian_exp_class/full_view_canadian_exp_class',$data);
}
