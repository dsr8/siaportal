...
class SINP_na extends BaseController
{


public function edit_sinp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/SINP_na/edit_sinp_na',$data);
}
}
///-------------------


public function edit_sinp_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/SINP_na/edit_sinp_na_new',$data);
}
}
///-------------------
...
public function full_view_ainp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/ainp_na/full_view_ainp_na',$data);
}


public function full_sinp_na($category,$id,$sid){
    ...
    return view('admin/sinp_na/full_view_ainp_na',$data);
}
