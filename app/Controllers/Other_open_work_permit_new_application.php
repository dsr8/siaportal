...
class Other_open_work_permit_new_application extends BaseController
{


public function edit_other_open_work_permit_new_application($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/other_open_work_permit_new_application/edit_other_open_work_permit_new_application',$data);
}
}
///-------------------
...
////////////////new start
public function edit_other_open_work_permit_new_application_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/other_open_work_permit_new_application/edit_other_open_work_permit_new_application_new',$data);
}
}
///-------------------
...
public function full_other_open_work_permit_new_application($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/other_open_work_permit_new_application/full_view_other_open_work_permit_new_application',$data);
}
