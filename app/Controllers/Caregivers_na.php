...
class Caregivers_na extends BaseController
{


public function edit_caregivers_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/caregivers_na/edit_caregivers_na',$data);
}
}
///-------------------
...
public function edit_caregivers_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/caregivers_na/edit_caregivers_na_new',$data);
}
}
///-------------------
/////////new end

public function full_caregivers_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/caregivers_na/full_view_caregivers_na',$data);
}
