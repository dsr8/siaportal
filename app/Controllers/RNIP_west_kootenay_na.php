...
class RNIP_west_kootenay_na extends BaseController
{


public function edit_rnip_west_kootenay_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/rnip_west_kootenay_na/edit_rnip_west_kootenay_na',$data);
}
}
///-------------------


public function edit_rnip_west_kootenay_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/rnip_west_kootenay_na/edit_rnip_west_kootenay_na_new',$data);
}
}
///-------------------

public function full_rnip_west_kootenay_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/rnip_west_kootenay_na/full_view_rnip_west_kootenay_na',$data);
}
