...
class FSW_na extends BaseController
{


public function edit_fsw_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/fsw_na/edit_fsw_na',$data);
}
}
///-------------------
...
public function edit_fsw_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/fsw_na/edit_fsw_na_new',$data);
}
}
///-------------------
///////////new end

public function full_fsw_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/fsw_na/full_view_fsw_na',$data);
}
