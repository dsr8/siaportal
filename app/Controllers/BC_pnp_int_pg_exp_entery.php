...
class BC_pnp_int_pg_exp_entery extends BaseController
{


 public function edit_bc_pnp_int_pg_exp_entery($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_int_pg_exp_entery/edit_bc_pnp_int_pg_exp_entery',$data);
}
}
///-------------------

//////////new start////////
 public function edit_bc_pnp_int_pg_exp_entery_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_int_pg_exp_entery/edit_bc_pnp_int_pg_exp_entery_new',$data);
}
}
///-------------------
...
public function full_bc_pnp_int_pg_exp_entery($category,$id,$sid){
    ...
    return view('admin/bc_pnp_int_pg_exp_entery/full_view_bc_pnp_int_pg_exp_entery',$data);
}
