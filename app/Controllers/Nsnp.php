...
class Nsnp extends BaseController
{

public function edit_nsnp_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/nsnp/edit_nsnp_new',$data);
}
}
///-------------------


public function full_nsnp($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/nsnp/full_view_nsnp',$data);
}
