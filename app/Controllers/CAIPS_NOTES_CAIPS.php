...
class CAIPS_NOTES_CAIPS extends BaseController
{


public function edit_caips_notes_caips($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/caips_notes_caips/edit_caips_notes_caips',$data);
}
}
///-------------------

///////////////new start
public function edit_caips_notes_caips_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/caips_notes_caips/edit_caips_notes_caips_new',$data);
}
}
///-------------------
...
public function full_caips_notes_caips($category,$id,$sid){
