...
class Indian_visa_na extends BaseController
{


public function edit_indian_visa_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/indian_visa_na/edit_indian_visa_na',$data);
}
}
///-------------------

///////new start
public function edit_indian_visa_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/indian_visa_na/edit_indian_visa_na_new',$data);
}
}
///-------------------
...
public function full_indian_visa_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/indian_visa_na/full_view_indian_visa_na',$data);
}
