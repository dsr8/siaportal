...
class Visitor_extension_inland extends BaseController
{


public function edit_visitor_extension_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_extension_inland/edit_visitor_extension_inland',$data);
}
}
///-------------------

public function edit_visitor_extension_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/visitor_extension_inland/edit_visitor_extension_inland_new',$data);
}
}
///-------------------
...
public function full_visitor_extension_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/visitor_extension_inland/full_view_visitor_extension_inland',$data);
}
