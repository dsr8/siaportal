...
class Minp_na extends BaseController
{


public function edit_minp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/minp_na/edit_minp_na',$data);
}
}
///-------------------
//////////new start
public function edit_minp_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/minp_na/edit_minp_na_new',$data);
}
}
///-------------------

/////////new end
public function full_minp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/minp_na/full_view_minp_na',$data);
}
