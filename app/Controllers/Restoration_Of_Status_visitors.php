...
class Restoration_Of_Status_visitors extends BaseController
{
...
////////////new start
public function edit_visitors_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/restoration_of_status_visitors/edit_visitors_new',$data);
}
}
...
public function full_visitors_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/restoration_of_status_visitors/full_visitors_new',$data);
