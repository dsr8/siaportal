...
class Citizenship_certi_application_minor extends BaseController
{


public function edit_citizenship_certi_application_minor($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Citizenship_certi_application_minor/edit_citizenship_certi_application_minor',$data);
}
}
///-------------------
...
public function edit_citizenship_certi_application_minor_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Citizenship_certi_application_minor/edit_citizenship_certi_application_minor_new',$data);
}
}
///-------------------
...
public function full_citizenship_certi_application_minor($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/Citizenship_certi_application_minor/full_view_citizenship_certi_application_minor',$data);
}
