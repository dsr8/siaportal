...
class Work_permit_extension_application extends BaseController
{

public function edit_work_permit_extension_application_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/work_permit_extension_application/edit_work_permit_extension_application_new',$data);
}
}
///-------------------


public function full_work_permit_extension_application($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/work_permit_extension_application/full_view_work_permit_extension_application',$data);
}
