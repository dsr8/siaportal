...
class Spausal_sponsorship_inland extends BaseController
{
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/spausal_sponsorship_inland/edit_spausal_sponsorship_inland',$data);
}
}
///-------------------
...
///////////////new start
public function edit_spausal_sponsorship_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/spausal_sponsorship_inland/edit_spausal_sponsorship_inland_new',$data);
}
}
///-------------------
////////////////new end

public function full_spausal_sponsorship_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/spausal_sponsorship_inland/full_view_spausal_sponsorship_inland',$data);
}
