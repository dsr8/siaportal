...
class Skill_worker extends BaseController
{

public function edit_skill_worker_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/skill_worker/edit_skill_worker_new',$data);
}
}
///-------------------


public function full_skill_worker($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/skill_worker/full_view_skill_worker',$data);
}
