...
////////////new
public function edit_worker_spousal_open_wp_inland_new($category,$id,$sid){
if ($this->request->getMethod()=='post'){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/worker_spousal_open_wp_inland/edit_worker_spousal_open_wp_inland_new',$data);
}
}
