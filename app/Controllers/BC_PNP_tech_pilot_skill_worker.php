...
class BC_PNP_tech_pilot_skill_worker extends BaseController
{


public function edit_bc_pnp_tech_pilot_skill_worker($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bc_pnp_tech_pilot_skill_worker/edit_bc_pnp_tech_pilot_skill_worker',$data);
}
}
///-------------------
...
public function edit_bc_pnp_tech_pilot_skill_worker_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bc_pnp_tech_pilot_skill_worker/edit_bc_pnp_tech_pilot_skill_worker_new',$data);
}
}
///-------------------
...
public function full_bc_pnp_tech_pilot_skill_worker($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_tech_pilot_skill_worker/full_view_bc_pnp_tech_pilot_skill_worker',$data);
}
