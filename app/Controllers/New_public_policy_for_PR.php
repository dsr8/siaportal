...
class New_public_policy_for_PR extends BaseController
{


public function edit_new_public_policy_for_PR_inland($category,$id,$sid){
...
$exp_date_to_apply = $this->request->getPost('exp_date_to_apply');
    $assign_to = $this->request->getPost('assign_to');
		...
		completed_mail_team($iggd,$name,$approve_note,$date_work_permit,$approval_letter,$approve_note);
	

$message1="Hi Team Application Completed -".$iggd." -Name-".$name." note  -".$approve_note." ";
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/new_public_policy_for_PR/edit_new_public_policy_for_PR_inland',$data);
}
}
///-------------------

//////////new startr
public function edit_new_public_policy_for_PR_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/new_public_policy_for_PR/edit_new_public_policy_for_PR_inland_new',$data);
}
}
///-------------------
///////////new end
...
public function full_view_new_public_policy_for_PR_edit($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/new_public_policy_for_PR/full_view_new_public_policy_for_PR',$data);
}
