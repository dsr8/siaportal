...
class Verify_replace_status_doc extends BaseController
{

public function edit_verify_replace_status_doc_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/verify_replace_status_doc/edit_verify_replace_status_doc_new',$data);
}
}
///-------------------


public function full_verify_replace_status_doc($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/verify_replace_status_doc/full_view_verify_replace_status_doc',$data);
}
