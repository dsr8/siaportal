...
class Oci extends BaseController
{


public function edit_oci_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Oci/edit_oci_na',$data);
}
}
///-------------------

//////////////////new start
public function edit_oci_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Oci/edit_oci_na_new',$data);
}
}
///-------------------
...
public function full_oci_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/Oci/full_view_oci_na',$data);
}
