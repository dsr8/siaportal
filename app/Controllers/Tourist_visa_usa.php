...
class Tourist_visa_usa extends BaseController
{


public function edit_toutist_visa_usa($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/tourist_visa_usa/edit_tourist_visa_usa',$data);
}
}
///-------------------
