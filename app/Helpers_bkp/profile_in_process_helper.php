<?php
function profile_in_process_team_mail($iggd,$name,$app_recv,$exp_date_to_apply){
...
function profile_in_process_client_mail_sms($name,$tname,$tmobile,$cmobile,$email){
