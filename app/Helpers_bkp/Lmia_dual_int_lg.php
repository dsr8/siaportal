...
class Lmia_dual_int_lg extends BaseController
{


public function edit_lmia_dual_int_low_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_dual_int_lg/edit_lmia_dual_int_low_wage',$data);
}
}
///-------------------

public function full_lmia_dual_int_low_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_dual_int_lg/full_view_lmia_dual_int_low_wage',$data);
}
