...
function information_requested_for_advertisement_team_mail($iggd,$info_doc_req_date,$feerp,$doc_await_note,$name){
	...
	@mail('Support@siaimmigration.com,office@siaimmigration.com,kam@siaimmigration.com,mkj@siaimmigration.com,no-reply@siaimmigration.comm',$subject,$message,$headers);
	

}


function information_requested_for_advertisement_client_mail_sms($name,$fname,$tmobile,$cmobile,$email){
	...
	$From="Sia Immigration";
           ...
           $emaill=$ee;
					...
					//$subject  = "";	
					$subject  = "Information Requested For Advertisement";						
					$headers  = "MIME-Version: 1.0\r\n";
 					$headers .= "Content-type: text/html; charset=iso-8859-1\r\n"; 					
 					$headers.="From: \"".$From."\"<".$emaill."> \r\n";
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>Information Requested For Advertisement.</td>
                            </tr>
...
$message1="Dear  ".$name."  Information Requested For Advertisement.";
