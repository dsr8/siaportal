...
class Lmia_wp_hg extends BaseController
{


public function edit_lmia_wp_high_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_wp_hg/edit_lmia_wp_high_wage',$data);
}
}
///-------------------

public function full_lmia_wp_high_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_wp_hg/full_view_lmia_wp_high_wage',$data);
}
