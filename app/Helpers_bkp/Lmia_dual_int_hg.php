...
class Lmia_dual_int_hg extends BaseController
{


public function edit_lmia_dual_int_high_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_dual_int_hg/edit_lmia_dual_int_high_wage',$data);
}
}
///-------------------

public function full_lmia_dual_int_high_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_dual_int_hg/full_view_lmia_dual_int_high_wage',$data);
}
