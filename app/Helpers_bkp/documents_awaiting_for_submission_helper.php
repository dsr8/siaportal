<?php
function documents_awaiting_for_submission_team_mail($iggd,$name,$invitation_date_tantative,$invitation_date_final){
	$From="Sia Immigration";
           ...
           $emaill=$ee;
					...
					$message .= 'Documents Requested Date : ' .$invitation_date_tantative.'<br>';
					$message .= 'Documents Received On : ' .$invitation_date_final.'<br>';	
...
function documents_awaiting_for_submission_client_mail_sms($name,$fname,$tmobile,$cmobile,$email){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>Documents Awaiting for Submission.</td>
                            </tr>
...
$message1="Dear  ".$name."  Documents Awaiting for Submission";
