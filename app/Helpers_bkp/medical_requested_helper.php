...
function medical_request_team_mail($iggd,$name,$date_for_medical,$date_for_medical_ten,$medical_note){
...
function medical_requested_client_mail_sms($name,$tname,$tmobile,$cmobile,$email){
