...
class Lmia_wp_lg extends BaseController
{


public function edit_lmia_wp_low_wage($category,$id,$sid){
...
$phone = array('919653364499','917341113549');
...
$exp_date_to_apply = $this->request->getPost('exp_date_to_apply');
   ...
   $st_oa_start_date=$this->request->getPost('st_oa_start_date');
   $st_oa_end_date=$this->request->getPost('st_oa_end_date');
	advertisement_started_team_mail($iggd,$iggd,$st_job_start_date,$st_job_end_date,$st_il_start_date,$st_il_end_date,$st_ki_start_date,$st_ki_end_date,$st_ca_start_date,$st_ca_end_date,$st_oa_start_date,$st_oa_end_date,$name);
...
$exp_date_to_apply = $this->request->getPost('exp_date_to_apply');
	...
	@mail('ds@siaimmigration.com,ns@siaimmigration.com,no-reply@siaimmigration.com',$subject,$message,$headers);
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_wp_lg/edit_lmia_wp_low_wage',$data);
}
}
///-------------------

public function full_lmia_wp_low_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_wp_lg/full_view_lmia_wp_low_wage',$data);
}
