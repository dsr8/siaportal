...
class Lmia_pr_lg extends BaseController
{


public function edit_lmia_pr_low_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_pr_lg/edit_lmia_pr_low_wage',$data);
}
}
///-------------------

public function full_lmia_pr_low_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_pr_lg/full_view_lmia_pr_low_wage',$data);
}
