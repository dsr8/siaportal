<?php
function AOR_IRCC_team_mail($iggd,$name,$aor_app_number,$aor_app_date,$link,$aor_online_detail,$aor_linkreason){
...
$From="Sia Immigration";
 ...
 function AOR_IRCC($name,$tname,$tmobile,$cmobile,$email){
