            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View Employer</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                             <?php foreach($emp as $cc){ ?>
                                            <tr>
                                                 <td><?php echo $cc['id'];?></td>
                                                <td><?php echo $cc['name'];?></td>
                                                <td><?php echo $cc['contact'];?></td>
                                                <td><?php echo $cc['email'];?></td>
                                                <td><?php echo $cc['city'];?>  </td>
                                                <td><?php echo $cc['country'];?></td>
                                                 <td><?php echo $cc['company_name'];?></td>    
                                                <td><?php echo $cc['company_type'];?></td>
                                              <td><a href="<?php echo base_url();?>/Siaportal/edit_emp/<?php echo $cc['id'];?>">Edit</a></td>
                                            </tr>
                                           <?php } ?>
