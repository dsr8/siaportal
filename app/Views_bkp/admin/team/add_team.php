            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_team_login"> 
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">First Name</label>
    <input class="form-control py-4" name="firstname" id="firstname" type="text" placeholder="Enter first name" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Last Name</label>
    <input class="form-control py-4" name="lastname" id="lastname" type="text" placeholder="Enter last name" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Email</label>
    <input class="form-control py-4"name="email" onfocusout="check_mail()"  id="email" type="text" placeholder="Enter email" /></div>
...
<div class="row">
 ...
 <div class="col-md-6">
    ...
    <input class="form-control py-4"name="mobile_no" id="mobile_no" type="text" placeholder="Enter Mobile Number" />
  </div>
    </div>
      </div>
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Password</label><input class="form-control py-4" id="password" type="text" name="password" placeholder="Enter password" required="required" /></div>
...
$.ajax({  
     ...
     url: 'https://canada.siaimmigration.com/Siaportal/check_mail_client/'+ee, 
