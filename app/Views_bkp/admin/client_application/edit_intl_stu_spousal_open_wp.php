...
<progress id="progress" value="0"></progress>
 ...
 <input type="radio" name="fee" id="fee" value="td_credit_card"  />Yes<br>
 <input type="radio" name="fee" id="fee1" value="client"  />No
</div>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                     <div class="form-group">
...
<?PHP $val = $tm['id'];?>
 ...
 <input type="radio" name="fee" id="fee" value="td_credit_card" onclick="own_card()" />Receiced<br>
 <input type="radio" name="fee" id="fee1" value="client" onclick="client_card()" />Pending
</div>
     
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 mb-4">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">fee received or pending</label>
 <input  class="form-control"  ame="exp_date_to_apply" id="datepicker"  type="text" placeholder="Enter Expected Date to apply" value="<?php  echo $dddd= $cpm['0']['exp_date_to_apply']; ?>"  readonly="readonly"  />
</div>
...
<textarea class="form-control" name="client_card_note" id="client_card_note" placeholder="Enter Client Note's if any"> </textarea>
 ...
 <input type="text" id="app_sub_date" name="app_sub_date" class="form-control" placeholder="Application submitted Date" >
</div>
     
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                      <div class="form-group">
 <label class="small mb-1" for="inputFirstName">address of immigration document received</label> <input type="text" id="app_sub_date" name="app_sub_date" class="form-control" placeholder="Application submitted Date" >
</div>
                ...
                <div class="table-tabs">
                  ...
                  <section class="section-preview">
                    ...
                    <div style="padding: 1px;   float:left;height:auto;width:100%">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <input type="text" name="app_number" id="app_number" class="form-control"  placeholder="Enter Application Number"   />
</div>
