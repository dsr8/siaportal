...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit BC PNP tech pilot skill worker</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/BC_PNP_tech_pilot_skill_worker/edit_bc_pnp_tech_pilot_skill_worker/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="472">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==472) { ?> 
       
        <option value="473">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==473) { ?> 
        <option value="474">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==474) { ?> 
         <option value="475">Approved</option> 
         <option value="476">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="472" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="473" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="474" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="476" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="475" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='472'){  
$( "#472" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='473'){
$( "#472" ).removeClass( "show" ).addClass( "hide" );
$( "#473" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='474'){

$( "#472" ).removeClass( "show" ).addClass( "hide" );

$( "#473" ).removeClass( "show" ).addClass( "hide" );

$( "#474" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='475'){

$( "#472" ).removeClass( "show" ).addClass( "hide" );
$( "#473" ).removeClass( "show" ).addClass( "hide" );
$( "#474" ).removeClass( "show" ).addClass( "hide" );
$( "#475" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='476'){

$( "#472" ).removeClass( "show" ).addClass( "hide" );
$( "#473" ).removeClass( "show" ).addClass( "hide" );
$( "#474" ).removeClass( "show" ).addClass( "hide" );
$( "#475" ).removeClass( "show" ).addClass( "hide" );
$( "#476" ).removeClass( "hide" ).addClass( "show" );
}
