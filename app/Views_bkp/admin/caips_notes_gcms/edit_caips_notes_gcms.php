...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit CAIPS NOTES GCMS</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/CAIPS_NOTES_GCMS/edit_caips_notes_gcms/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="482">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==482) { ?> 
       
        <option value="483">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==483) { ?> 
        <option value="484">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==484) { ?> 
         <option value="485">Approved</option> 
         <option value="486">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="482" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="483" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="484" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="486" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="485" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='482'){  
$( "#482" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='483'){
$( "#482" ).removeClass( "show" ).addClass( "hide" );
$( "#483" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='484'){

$( "#482" ).removeClass( "show" ).addClass( "hide" );

$( "#483" ).removeClass( "show" ).addClass( "hide" );

$( "#484" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='485'){

$( "#482" ).removeClass( "show" ).addClass( "hide" );
$( "#483" ).removeClass( "show" ).addClass( "hide" );
$( "#484" ).removeClass( "show" ).addClass( "hide" );
$( "#485" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='486'){

$( "#482" ).removeClass( "show" ).addClass( "hide" );
$( "#483" ).removeClass( "show" ).addClass( "hide" );
$( "#484" ).removeClass( "show" ).addClass( "hide" );
$( "#485" ).removeClass( "show" ).addClass( "hide" );
$( "#486" ).removeClass( "hide" ).addClass( "show" );
}
