...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Lmia work permit Low Wage</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Lmia_wp_lg/edit_lmia_wp_low_wage/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="440">Assign Team Member</option> 
          <?php } elseif($app_st=='440'){ ?> 
        <option value="441">Application In Process</option>
         <?php } elseif($app_st=='441'){ ?> 
        <option value="442">Information Requested For Advertisement</option>
         <?php } elseif($app_st=='442'){ ?> 
        <option value="443">Advertisement Started</option>   
         <?php } elseif($app_st=='443'){ ?>          
        <option value="444">Documents Awaiting For Submission</option>  
         <?php } elseif($app_st=='444'){ ?> 
        <option value="445">Advertisement Renewal 1st Stage</option>    
         <?php } elseif($app_st=='445'){ ?>       
        <option value="446">Application Submitted</option> 
         <?php } elseif($app_st=='446'){ ?>            
        <option value="447">LMIA Number Received</option>  
         <?php } elseif($app_st=='447'){ ?>           
        <option value="448">Interview/ADR Requested</option>   
         <?php } elseif($app_st=='448'){ ?>          
        <option value="449">Interview/ADR Completed</option>  
         <?php } elseif($app_st=='449'){ ?>           
        <option value="450">Advertisement Renewal 2nd Stage</option> 
         <?php } elseif($app_st=='450'){ ?> 
         <option value="451">Approved</option> 
          <option value="234">Refused</option> 
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="440" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="441" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="442" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea  class="form-control"  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Advertisement Fees Paid Invoice Number" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="443" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="ad_oa_end_date" id="ad_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="444" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="445" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="st_oa_end_date" id="st_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="446" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="447"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="lmia_rec_date" id="lmia_rec_date" class="form-control" readonly=""   placeholder="" value="<?php echo $cpm['0']['lmia_rec_date'];?>"  />
</div>
 ...
 <input type="text" name="lmia_number" id="lmia_number" placeholder="Enter LMIA Number" class="form-control" value="<?php echo $cpm['0']['lmia_number'];?>">
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="448" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="449" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="450" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="stt_oa_end_date" id="stt_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="234" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="451" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='440'){  
$( "#440" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='441'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='442'){

$( "#440" ).removeClass( "show" ).addClass( "hide" );

$( "#441" ).removeClass( "show" ).addClass( "hide" );

$( "#442" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='443'){

$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='444'){

$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
$( "#444" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='445'){

$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
$( "#444" ).removeClass( "show" ).addClass( "hide" );
$( "#445" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='446'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
$( "#444" ).removeClass( "show" ).addClass( "hide" );
$( "#445" ).removeClass( "show" ).addClass( "hide" );
$( "#446" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='447'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
$( "#444" ).removeClass( "show" ).addClass( "hide" );
$( "#445" ).removeClass( "show" ).addClass( "hide" );  
$( "#446" ).removeClass( "show" ).addClass( "hide" );
$( "#447" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='448'){
  $( "#440" ).removeClass( "show" ).addClass( "hide" );
  $( "#441" ).removeClass( "show" ).addClass( "hide" );
  $( "#442" ).removeClass( "show" ).addClass( "hide" );
  $( "#443" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#445" ).removeClass( "show" ).addClass( "hide" );
  $( "#446" ).removeClass( "show" ).addClass( "hide" );
  $( "#447" ).removeClass( "show" ).addClass( "hide" );
  $( "#448" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='449'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
...
$( "#446" ).removeClass( "show" ).addClass( "hide" );
$( "#447" ).removeClass( "show" ).addClass( "hide" );
$( "#448" ).removeClass( "show" ).addClass( "hide" );
$( "#449" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='450'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
...
$( "#447" ).removeClass( "show" ).addClass( "hide" );
$( "#448" ).removeClass( "show" ).addClass( "hide" );
$( "#449" ).removeClass( "show" ).addClass( "hide" );
$( "#450" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='451'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
...
$( "#448" ).removeClass( "show" ).addClass( "hide" );
$( "#449" ).removeClass( "show" ).addClass( "hide" );
$( "#450" ).removeClass( "show" ).addClass( "hide" );
$( "#451" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='234'){
$( "#440" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#442" ).removeClass( "show" ).addClass( "hide" );
$( "#443" ).removeClass( "show" ).addClass( "hide" );
...
$( "#449" ).removeClass( "show" ).addClass( "hide" );
$( "#450" ).removeClass( "show" ).addClass( "hide" );
$( "#234" ).removeClass( "hide" ).addClass( "show" );
}
