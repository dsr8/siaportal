      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon">
                    ...
                    <img style="height:70px;width:70px;" src="https://image.flaticon.com/icons/svg/2991/2991160.svg">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Dharminder Singh
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
               <a target="_blank" href="https://www.siaimmigration.com/Home/news">
              <div class="card card-stats">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-tabs card-header-primary" ><!--style="background-image: url('https://canada.siaimmigration.com/public/assets_client/img/197.jpg'); background-size: 500px 100px;background-repeat: no-repeat;"-->
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <span class="nav-tabs-title">Refer A friend</span>
...
<div class="modal fade" id="getCodeModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <!--div class="col-md-6">
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card" style="min-height:421px;max-height: 421px; overflow:scroll;">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Refer Cases Status</h4>
