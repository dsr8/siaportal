...
<div class="row">
 ...
 <div class="col-md-12">
    ...
    <label class="small mb-1" for="inputFirstName">Number with country code</label><input class="form-control py-4" id="number" type="text" name="number" value="<?php echo $prospect['0']['number'];?>" placeholder="Enter Number" />
</div>
</div>
</div>
