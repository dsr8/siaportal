...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit intl stu spousal open wp Inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Intl_stu_spousal_open_wp_inland/edit_intl_stu_spousal_open_wp_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="36">Application in Process</option>
      <?php } elseif($app_st=='36'){ ?>
        <option value="313">document awaiting for submission</option>
         <?php } elseif($app_st=='313'){ ?>
        <option value="37">Application Submitted</option> 
         <?php } elseif($app_st=='37'){ ?>           
        <option value="38">Biometric Requested</option> 
         <?php } elseif($app_st=='38'){ ?> 
        <option value="39">Biometric Completed</option>   
         <?php } elseif($app_st=='39'){ ?>       
        <option value="40">Interview/ADR Requested</option>   
         <?php } elseif($app_st=='40'){ ?>         
        <option value="41">Interview/ADR Completed</option>    
         <?php } elseif($app_st=='41'){ ?>        
        <option value="42"> Medical Requested</option>  
         <?php } elseif($app_st=='42'){ ?>          
        <option value="43">Refused</option>            
      ...
      <?php } ?>
                  ...
                  <!--/Table Style-->
                        ...
                        <div class="row">
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="36" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="radio" name="c_transfer" id="c_transfer" <?php if($cpm['0']['c_transfer']=='yes'){ echo "checked=checked";}  ?>   value="yes"  />Yes<br>
 <input type="radio" name="c_transfer" id="c_transfer" <?php if($cpm['0']['c_transfer']=='no'){ echo "checked=checked";}  ?>  value="no"  />No
</div>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                     <div class="form-group">
...
<!----->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="313" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Document Awaiting For Submission</h2>
                <div class="table-tabs">
                  <!--Table Style-->
                  <section class="section-preview">
                    <!-- Default inline 1-->
 ...
 <textarea  class="form-control"  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Note's" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
</div>
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="37" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <input type="text" id="app_number" name="app_number" value="<?php echo $cpm['0']['application_number'];?>"class="form-control" placeholder="Enter application number" readonly >
</div>
     
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                      <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>" readonly>
</div>
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="38"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control"readonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="39" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea class="form-control" name="bio_com_note"  id="bio_com_note" ><?php echo $cpm['0']['bio_com_note'];?>"</textarea>
  ...
  <!--section End -->
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="40" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="41" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="42" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="date_for_medical_ten" id="date_for_medical_ten" placeholder="Enter date for medical tentative" class="form-control"   readonly="" value="<?php echo $cpm['0']['date_for_medical_ten'];?>"  />
</div> 
 ...
 <textarea name="medical_note" id="medical_note" placeholder="Enter note's" class="form-control" ><?php echo $cpm['0']['medical_note'];?></textarea>
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="43" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="44" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='36'){  
$( "#36" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='313'){
$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='37'){

$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );

$( "#37" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='38'){

$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );
$( "#37" ).removeClass( "show" ).addClass( "hide" );
$( "#38" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='39'){

$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );
$( "#37" ).removeClass( "show" ).addClass( "hide" );
$( "#38" ).removeClass( "show" ).addClass( "hide" );
$( "#39" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='40'){

$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );
$( "#37" ).removeClass( "show" ).addClass( "hide" );
$( "#38" ).removeClass( "show" ).addClass( "hide" );
$( "#39" ).removeClass( "show" ).addClass( "hide" );
$( "#40" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='41'){
$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );
$( "#37" ).removeClass( "show" ).addClass( "hide" );
$( "#38" ).removeClass( "show" ).addClass( "hide" );
$( "#39" ).removeClass( "show" ).addClass( "hide" );
$( "#40" ).removeClass( "show" ).addClass( "hide" );
$( "#41" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='42'){
$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );
$( "#37" ).removeClass( "show" ).addClass( "hide" );
$( "#38" ).removeClass( "show" ).addClass( "hide" );
$( "#39" ).removeClass( "show" ).addClass( "hide" );
$( "#40" ).removeClass( "show" ).addClass( "hide" );  
$( "#41" ).removeClass( "show" ).addClass( "hide" );
$( "#42" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='43'){
  $( "#36" ).removeClass( "show" ).addClass( "hide" );
  $( "#313" ).removeClass( "show" ).addClass( "hide" );
  $( "#37" ).removeClass( "show" ).addClass( "hide" );
  $( "#38" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#40" ).removeClass( "show" ).addClass( "hide" );
  $( "#41" ).removeClass( "show" ).addClass( "hide" );
  $( "#42" ).removeClass( "show" ).addClass( "hide" );
  $( "#43" ).removeClass( "hide" ).addClass( "show" );
  $("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='44'){
$( "#36" ).removeClass( "show" ).addClass( "hide" );
$( "#313" ).removeClass( "show" ).addClass( "hide" );
$( "#37" ).removeClass( "show" ).addClass( "hide" );
$( "#38" ).removeClass( "show" ).addClass( "hide" );
...
$( "#41" ).removeClass( "show" ).addClass( "hide" );
$( "#42" ).removeClass( "show" ).addClass( "hide" );
$( "#43" ).removeClass( "show" ).addClass( "hide" );
$( "#44" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
