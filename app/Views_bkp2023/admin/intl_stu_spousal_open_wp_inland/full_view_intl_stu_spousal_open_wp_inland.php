...
<input type="hidden"  name="news_image1_old" value="<?php echo $cpm['0']['voice_msg'];?>">
 ...
 <input  class="form-control"  name="gc_username" id="gc_username"  type="text" placeholder="Enter GC KEY username " value="<?php echo $cpm['0']['gc_username'];?>" readonly  />
</div>
 ...
 <input  class="form-control"  name="gc_password" id="gc_password"  type="text" placeholder="Enter GC KEY password" value="<?php echo $cpm['0']['gc_password'];?>"  readonly  />
</div>
