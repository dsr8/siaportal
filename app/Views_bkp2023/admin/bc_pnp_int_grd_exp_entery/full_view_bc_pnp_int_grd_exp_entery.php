...
<progress id="progress" value="0"></progress>
 ...
 <input type="text" id="date_of_creation_exp" name="date_of_creation_exp" class="form-control"   readonly="readonly" placeholder="Enter date Of Creation" value="<?php echo $cpm['0']['date_of_creation_exp'];?>" />
</div>

<div class="form-group">
 <label class="small mb-1" for="inputFirstName">Job NOC</label>
 <input type="text" class="form-control" value="<?php echo $cpm['0']['job_noc_exp'];?>" name="job_noc_exp" id="job_noc_exp" placeholder="Enter job noc"  readonly="readonly"   />
</div>
 ...
 <input type="text" name="app_number_exp" id="app_number_exp" value="<?php echo $cpm['0']['app_number_exp'];?>" placeholder="Enter application number" class="form-control" readonly="readonly"   />
</div>
<div class="form-group">
 ...
 <input type="text" name="reg_score_exp" id="reg_score_exp" value="<?php echo $cpm['0']['reg_score_exp'];?>"  placeholder="Enter registration score" class="form-control" readonly="readonly" />
</div>
 ...
 <input type="text" name="log_in_info_exp" id="log_in_info_exp"  value="<?php echo $cpm['0']['log_in_info_exp'];?>" placeholder="Enter log in info PNP" class="form-control" readonly="readonly"   />
</div>
...
<div class="form-group">
 <label class="small mb-1" for="inputFirstName">Job NOC</label>
 <input type="text" class="form-control" value="<?php echo $cpm['0']['job_noc'];?>" name="job_noc" id="job_noc" placeholder="Enter job noc" readonly="readonly"   />
</div>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Application Number </label>
 <input type="text" name="app_number" id="app_number" value="<?php echo $cpm['0']['application_number'];?>" placeholder="Enter application number" class="form-control" readonly="readonly"    />
</div>
<div class="form-group">
 <label class="small mb-1" for="inputFirstName">Upload Document </label>
 ...
 <input  name="upload_doc_old" id="upload_doc_old" type="hidden" value="<?php echo $cpm['0']['upload_doc'];?>"   />
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Registration Score</label>
 <input type="text" name="reg_score" id="reg_score" value="<?php echo $cpm['0']['reg_score'];?>"  placeholder="Enter registration score" class="form-control" readonly="readonly" />
</div>
                   ...
                   <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Log In Info PNP</label>
 <input type="text" name="log_in_info" id="log_in_info"  value="<?php echo $cpm['0']['log_in_info_pnp'];?>" placeholder="Enter log in info PNP" class="form-control" readonly="readonly"   />
</div>
 ...
 <textarea name="invit_withdrawn_reason" id="invit_withdrawn_reason"  readonly="readonly"  placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['invit_withdrawn_reason'];?> </textarea>  
</div>
 ...
 <input type="text" name="confirm_with" id="confirm_with" value="<?php echo $cpm['0']['confirm_with'];?>"  placeholder="Enter confirm with" readonly="readonly" class="form-control">
...
<div class="form-group">
 ...
 <input type="text" name="amount" id="amount" value="<?php echo $cpm['0']['amount'];?>" placeholder="Enter amount" class="form-control" readonly="readonly">
...
<div class="form-group">
 ...
 <textarea name="client_card_note" id="client_card_note" readonly="readonly"   placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['client_card_note'];?></textarea>  
</div>
 ...
 <textarea name="adr_note" id="adr_note" placeholder="Enter adr notes" readonly="readonly" value="<?php echo $cpm['0']['adr_note'];?>" class="form-control"></textarea>  
</div>
 ...
 <input  name="approval_doc_old" id="approval_doc_old" type="hidden" readonly="readonly" value="<?php echo $cpm['0']['approval_doc'];?>"   />
</div>
                ...
                <div class="table-tabs">
                  ...
                  <section class="section-preview">
                    ...
                    <div style="padding: 1px;   float:left;height:auto;width:100%">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Reason</label>
 <TEXTAREA   name="nomination_refused_reason" id="nomination_refused_reason" value="<?php echo $cpm['0']['nomination_refused_reason'];?>" readonly="readonly"  placeholder="Enter reason" class="form-control" ></TEXTAREA>
</div>
 ...
 <select class="form-control" name="mode_client_payment_exp">
   ...
   <option <?php echo ($cpm['0']['mode_client_payment'] == 'Bambora')?"selected":"" ?> value="Bambora">Bambora</option>
     ...
     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Confirm With</label><br>
 <input type="text" name="confirm_with_exp" id="confirm_with_exp" readonly="readonly" value="<?php echo $cpm['0']['confirm_with_exp'];?>"  placeholder="Enter confirm with" class="form-control">
...
<div class="form-group">
 <label class="small mb-1" for="inputFirstName">Amount</label><br>
 <input type="text" name="amount_exp" id="amount_exp" readonly="readonly" value="<?php echo $cpm['0']['amount_exp'];?>" placeholder="Enter amount" class="form-control">
...
<div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <textarea name="client_card_note_exp" id="client_card_note_exp"  readonly="readonly"  placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['client_card_note_exp'];?></textarea>  
</div>
 ...
 <input type="text" name="adr_deadline_exp" id="adr_deadline_exp" class="form-control" readonly=""   placeholder="Enter adr deadline"  value="<?php echo $cpm['0']['adr_deadline_exp'];?>" />
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 mb-6">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName"> Adr Note's</label>
 <textarea name="adr_note_exp" id="adr_note_exp" placeholder="Enter adr notes" readonly="readonly" value="<?php echo $cpm['0']['adr_note_exp'];?>" class="form-control"></textarea>  
</div>
                ...
                <div class="table-tabs">
                  ...
                  <section class="section-preview">
                    ...
                    <div style="padding: 1px;   float:left;height:auto;width:100%">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Application Number</label>
 <input type="text" name="aor_app_number" id="aor_app_number"  value="<?php echo $cpm['0']['aor_app_number'];?>"class="form-control" readonly="readonly" placeholder="Enter application number"   />
</div>
 ...
 <input type="text" name="date_for_medical_ten" id="date_for_medical_ten" placeholder="Enter date for medical tentative" class="form-control" value="<?php echo $cpm['0']['date_for_medical_ten'];?>" readonly=""  />
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 mb-4">
                    ...
                    <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <textarea name="medical_note" id="medical_note"  readonly="readonly" placeholder="Enter note's" class="form-control" ><?php echo $cpm['0']['medical_note'];?></textarea>
</div> 
 ...
 <input type="text" name="medical_submit" id="medical_submit" value="<?php echo $cpm['0']['medical_submit'];?>" placeholder="Enter date for medical submit" class="form-control" readonly="" value=""   />
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 mb-6">
                    ...
                    <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <textarea name="medical_sub_note" id="medical_sub_note" class="form-control" readonly="readonly"  placeholder="Enter note's"  ><?php echo $cpm['0']['medical_sub_note'];?></textarea>
</div> 
                ...
                <div class="table-tabs">
                  ...
                  <section class="section-preview">
                    ...
                    <div style="padding: 1px;   float:left;height:auto;width:100%">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <textarea name="approve_note" id="approve_note" class="form-control" readonly="readonly"  placeholder="Enter note" ><?php echo $cpm['0']['approve_note'];?></textarea>
</div>
                ...
                <div class="table-tabs">
                  ...
                  <section class="section-preview">
                    ...
                    <div style="padding: 1px;   float:left;height:auto;width:100%">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <textarea name="refused_note" id="refused_note" class="form-control" readonly="readonly" placeholder="Enter Refused Note's" ><?php echo $cpm['0']['refused_note'];?></textarea>
</div>
