...
if($app_st=='35'){ ?>
        ...
        <option value="523">Profile in Process(exp Entry)</option>
         <?php } elseif($app_st=='523'){ ?>
        
        <option value="524">Profile Created (exp Entry)</option> 
         <?php } elseif($app_st=='524'){ ?>  
         

 <option value="521">Profile in Process(Bcpnp)</option>  
  <?php } elseif($app_st=='521'){ ?>
  
  <option value="522">Profile Created(Bcpnp)</option>
   <?php } elseif($app_st=='522'){ ?>    
        ...
        <option value="526">Invitation withdrawn (Bcpnp)</option>
         ...
         <!--?php } elseif($app_st=='525'){ ?-->
        
        <!--option value="526">Invitation withdrawn (Bcpnp)</option-->
         <?php } elseif($app_st=='526' || $app_st=='525' ){ ?> 
          <option value="527">Application In Process (Bcpnp)</option> 
           <?php } elseif($app_st=='527'){ ?>      
        
        <option value="528">Application submitted (Bcpnp)</option> 
         <?php } elseif($app_st=='528'){ ?>   
               
        <option value="529">Adr BCPNP </option> 
         <?php } elseif($app_st=='529'){ ?>
               
        <option value="530">Nomination Approved </option> 
         <?php } elseif($app_st=='530'){ ?>
                  
        <option value="531">Nomination refused</option> 
         <?php } elseif($app_st=='531'){ ?>
                  
        <!--option value="9">Federal Application Sent</option!--> 
         <option value="532">Express entry invitation received</option> 
          <?php } elseif($app_st=='532'){ ?>

           <option value="533">Application In Process(Exp Entry)</option> 
            <?php } elseif($app_st=='533'){ ?>

             <option value="534">Application Submitted (Exp Entry)</option> 
              <?php } elseif($app_st=='534'){ ?>
              <option value="535">Adr Exp Entry </option> 
               <?php } elseif($app_st=='535'){ ?>
         ...
         <?php } ?>
                  ...
                  <!--/Table Style-->
                        ...
                        <div class="row">
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="523" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="524" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <input type="text" name="log_in_info_exp" id="log_in_info_exp"  value="<?php echo $cpm['0']['log_in_info_exp'];?>" placeholder="Enter log in info PNP" class="form-control"    />
  ...
  <!--section End -->
                   ...
                   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="521" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="522" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <input type="text" name="log_in_info" id="log_in_info"  value="<?php echo $cpm['0']['log_in_info_pnp'];?>" placeholder="Enter log in info PNP" class="form-control"    />
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="525" style="margin-top:1px;">
            <div class="right-side">
              <div class="content">
 ...
 <input type="text" name="invitation_date_final" id="invitation_date_final" value="<?php echo $cpm['0']['invitation_date_final'];?>" class="form-control" readonly=""   placeholder="Enter final submission date "  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="526" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea name="invit_withdrawn_reason" id="invit_withdrawn_reason"   placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['invit_withdrawn_reason'];?> </textarea>  
  ...
  <!--section End -->
                               ...
                               <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="527" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="date_to_apply" id="date_to_apply"  type="text" placeholder="Enter information request sent on" value="<?php echo $cpm['0']['exp_date_to_apply'];?>"  readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="528" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <textarea name="client_card_note" id="client_card_note"   placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['client_card_note'];?></textarea>  
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="529"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Adr BCPNP</h2>
                <div class="table-tabs">
 ...
 <textarea name="adr_note" id="adr_note" placeholder="Enter adr notes" value="<?php echo $cpm['0']['adr_note'];?>" class="form-control"></textarea>  
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="530" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  name="approval_doc_old" id="approval_doc_old" type="hidden" value="<?php echo $cpm['0']['approval_doc'];?>"   />
  ...
  <!--section End -->
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="531" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <TEXTAREA   name="nomination_refused_reason" id="nomination_refused_reason" value="<?php echo $cpm['0']['nomination_refused_reason'];?>"  placeholder="Enter reason" class="form-control" ></TEXTAREA>
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="532" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="file" name="courier_receipt_slip" id=""   value=""   />
  ...
  <!--section End -->
                       <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="533" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="exp_date_to_apply_expp" id="exp_date_to_apply_expp"  type="text" placeholder="Enter information request sent on" value="<?php echo $cpm['0']['exp_date_to_apply_expp'];?>"  readonly="readonly"  />
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="534" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <textarea name="client_card_note_exp" id="client_card_note_exp"   placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['client_card_note_exp'];?></textarea>  
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="535"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="536" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
 ...
 <textarea name="approve_note" id="approve_note" class="form-control"  placeholder="Enter note" ><?php echo $cpm['0']['approve_note'];?></textarea>
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="537" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
