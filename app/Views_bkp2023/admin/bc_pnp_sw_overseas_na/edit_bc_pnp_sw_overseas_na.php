...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit BC pnp sw overseas na</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Bc_pnp_sw_overseas_na/edit_bc_pnp_sw_overseas_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="355">Assign Team Member</option> 
          <?php } elseif($app_st=='355'){ ?> 
        <option value="356">Application in Process</option>
          <?php } elseif($app_st=='356'){ ?> 
        <option value="357">Application Submitted</option> 
          <?php } elseif($app_st=='357'){ ?> 
         
         <option value="358">Approved</option> 
         <option value="359">Refused</option>
       <?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="355" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="356" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="357" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="359" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="358" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='355'){  
$( "#355" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='356'){
$( "#355" ).removeClass( "show" ).addClass( "hide" );
$( "#356" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='357'){

$( "#355" ).removeClass( "show" ).addClass( "hide" );

$( "#356" ).removeClass( "show" ).addClass( "hide" );

$( "#357" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='358'){

$( "#355" ).removeClass( "show" ).addClass( "hide" );
$( "#356" ).removeClass( "show" ).addClass( "hide" );
$( "#357" ).removeClass( "show" ).addClass( "hide" );
$( "#358" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='359'){

$( "#355" ).removeClass( "show" ).addClass( "hide" );
$( "#356" ).removeClass( "show" ).addClass( "hide" );
$( "#357" ).removeClass( "show" ).addClass( "hide" );
$( "#358" ).removeClass( "show" ).addClass( "hide" );
$( "#359" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
