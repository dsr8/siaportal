...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Bc Pnp Int Grd(<?php echo $cpm['0']['id'];?>)</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/BC_pnp_int_grd/edit_bc_pnp_int_grd/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="2">Profile in Process</option>
          <?php } elseif($app_st=='2'){ ?>
        <option value="3">Profile Created</option>   
          <?php } elseif($app_st=='3'){ ?>         
        <option value="4">Invitation received</option>  
          <!--?php } elseif($app_st=='4'){ ?-->
        <option value="310">Invitation withdrawn</option>       
          <?php } elseif(($app_st=='310')||$app_st=='4'){ ?>   
        <option value="5">Application submitted</option>    
          <?php } elseif($app_st=='5'){ ?>        
        <option value="6">Adr BCPNP</option> 
          <?php } elseif($app_st=='6'){ ?>           
        <option value="7">Nomination Approved</option> 
          <?php } elseif($app_st=='7'){ ?>           
        <option value="8">Nomination refused</option> 
          <?php } elseif($app_st=='8'){ ?>           
        <option value="9">Federal Application Sent</option> 
          <?php } elseif($app_st=='9'){ ?>
        <option value="311">AOR IRCC</option>   
          <?php } elseif($app_st=='311'){ ?>            
        <option value="10">ADR IRCC</option> 
          <?php } elseif($app_st=='10'){ ?>           
        <option value="11">Medical requested</option> 
          <?php } elseif($app_st=='11'){ ?>
        <option value="312">Medical submited</option>
          <?php } elseif($app_st=='312'){ ?>           
        <option value="12">Passport requested</option> 
          <?php } elseif($app_st=='12'){ ?>           
        <option value="13">Approved</option>            
        <option value="14">Refused</option>
    <?php } ?>
                  ...
                  <!--/Table Style-->
                        ...
                        <div class="row">
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="2" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="exp_date_to_apply" id="datepicker"  type="text" placeholder="Enter expected date to apply" value="<?php echo $cpm['0']['exp_date_to_apply'];?>"   readonly="readonly"  />
</div>
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="3" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <input type="text" name="log_in_info" id="log_in_info"  value="<?php echo $cpm['0']['log_in_info_pnp'];?>" placeholder="Enter log in info PNP" class="form-control"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="4" style="margin-top:1px;">
            <div class="right-side">
              <div class="content">
 ...
 <input type="text" name="invitation_date_final" id="invitation_date_final" value="<?php echo $cpm['0']['invitation_date_final'];?>" class="form-control" readonly=""   placeholder="Enter final submission date "  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="310" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea name="invit_withdrawn_reason" id="invit_withdrawn_reason"   placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['invit_withdrawn_reason'];?> </textarea>  
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="5" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <textarea name="client_card_note" id="client_card_note"   placeholder="Enter reason" class="form-control"><?php echo $cpm['0']['client_card_note'];?></textarea>  
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="6"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Adr BCPNP</h2>
                <div class="table-tabs">
 ...
 <textarea name="adr_note" id="adr_note" placeholder="Enter adr notes" value="<?php echo $cpm['0']['adr_note'];?>" class="form-control"></textarea>  
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="7" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  name="approval_doc_old" id="approval_doc_old" type="hidden" value="<?php echo $cpm['0']['approval_doc'];?>"   />
  ...
  <!--section End -->
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="8" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <TEXTAREA   name="nomination_refused_reason" id="nomination_refused_reason" value="<?php echo $cpm['0']['nomination_refused_reason'];?>"  placeholder="Enter reason" class="form-control" ></TEXTAREA>
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="9" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="13" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
 ...
 <textarea name="approve_note" id="approve_note" class="form-control"  placeholder="Enter note" ><?php echo $cpm['0']['approve_note'];?></textarea>
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="14" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
...
else if((app_status=='310')||(app_status=='4')){
