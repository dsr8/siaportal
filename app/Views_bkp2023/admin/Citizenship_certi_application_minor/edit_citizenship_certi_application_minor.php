...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Citizenship certi application Minor</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Citizenship_certi_application_minor/edit_citizenship_certi_application_minor/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="499">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==499) { ?> 
       
        <option value="266">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==266) { ?> 
        <option value="269">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==269) { ?> 
         <option value="272">Approved</option> 
         <option value="273">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="499" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="266" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="269" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="273" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="272" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='499'){  
$( "#499" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='266'){
$( "#499" ).removeClass( "show" ).addClass( "hide" );
$( "#266" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='269'){

$( "#499" ).removeClass( "show" ).addClass( "hide" );

$( "#266" ).removeClass( "show" ).addClass( "hide" );

$( "#269" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='272'){

$( "#499" ).removeClass( "show" ).addClass( "hide" );
$( "#266" ).removeClass( "show" ).addClass( "hide" );
$( "#269" ).removeClass( "show" ).addClass( "hide" );
$( "#273" ).removeClass( "show" ).addClass( "hide" );
$( "#272" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='273'){

$( "#499" ).removeClass( "show" ).addClass( "hide" );
$( "#266" ).removeClass( "show" ).addClass( "hide" );
$( "#269" ).removeClass( "show" ).addClass( "hide" );
$( "#272" ).removeClass( "show" ).addClass( "hide" );
$( "#273" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
