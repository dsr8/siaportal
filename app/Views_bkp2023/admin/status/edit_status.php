            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/edit_status/<?php echo $status['0']['id'];?>"> 
                        <div class="row">
                              <div class="col-xl-3 col-md-3"></div>
                            <div class="col-xl-6 col-md-6">
                                
<div class="form-group"><label class="small mb-1" for="inputFirstName"> Category</label>
    <select class="form-control"NAME="category_id" id="category" onChange="dev()">
        <option value="<?php echo $status['0']['category_id'];?>"><?php echo $status['0']['ct'];?></option>
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Type</label>
    <select class="form-control"NAME="type_id" id="subcat">
        <option value="<?php echo $status['0']['type_id'];?>"><?php echo $status['0']['ty'];?></option>
        
                                                                
                                </select></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Status</label>
    <input class="form-control py-4"name="app_status" id="app_status" type="text" value="<?php echo $status['0']['app_status'];?>" placeholder="Enter Status" /></div>
...
//alert('dss');
 ...
 //alert(categoryid);
var url= '<?php echo base_url().'/Siaportal/gettypee';?>/'+categoryid;
//alert(url);
 //alert(url);
    $.ajax({  type: "POST",     
     url: '<?php echo base_url().'/Siaportal/gettypee';?>/'+categoryid, 
