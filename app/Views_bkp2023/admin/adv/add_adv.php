            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_adv"> 
                        <div class="row">
                          <div class="col-xl-3 col-md-3"></div>
                            <div class="col-xl-6 col-md-6">
                                
<div class="form-group"><label class="small mb-1" for="inputFirstName">Advertisement Heading</label>
    <input class="form-control py-4" name="add_head" id="add_head" type="text" placeholder="Enter Advertisement Heading" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Advertisement Type</label>
    <input class="form-control py-4" name="add_type" id="add_type" type="text" placeholder="Enter Advertisement Type" /></div>
