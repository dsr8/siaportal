...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Passport NA</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Passport_na/edit_passport_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="405">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==405) { ?> 
       
        <option value="406">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==406) { ?> 
        <option value="407">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==407) { ?> 
         <option value="408">Approved</option> 
         <option value="409">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="405" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="406" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="col-lg-6 col-md-6 col-sm-6 mb-6">
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="407" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="409" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="408" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='405'){  
$( "#405" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='406'){
$( "#405" ).removeClass( "show" ).addClass( "hide" );
$( "#406" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='407'){

$( "#405" ).removeClass( "show" ).addClass( "hide" );

$( "#406" ).removeClass( "show" ).addClass( "hide" );

$( "#407" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='408'){

$( "#405" ).removeClass( "show" ).addClass( "hide" );
$( "#406" ).removeClass( "show" ).addClass( "hide" );
$( "#407" ).removeClass( "show" ).addClass( "hide" );
$( "#408" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='409'){

$( "#405" ).removeClass( "show" ).addClass( "hide" );
$( "#406" ).removeClass( "show" ).addClass( "hide" );
$( "#407" ).removeClass( "show" ).addClass( "hide" );
$( "#408" ).removeClass( "show" ).addClass( "hide" );
$( "#409" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
