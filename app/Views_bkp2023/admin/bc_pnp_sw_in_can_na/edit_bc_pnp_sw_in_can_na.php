...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit BC pnp sw in can na</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/BC_pnp_sw_in_can_na/edit_bc_pnp_sw_in_can_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="350">Assign Team Member</option>
         <?php } elseif($app_st=='350'){ ?> 
        <option value="351">Application in Process</option>
         <?php } elseif($app_st=='351'){ ?>
        <option value="352">Application Submitted</option> 
         <?php } elseif($app_st=='352'){ ?>
         
         <option value="353">Approved</option> 
         <option value="354">Refused</option> 
...
<?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="350" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="351" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="352" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="354" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="353" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='350'){  
$( "#350" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='351'){
$( "#351" ).removeClass( "show" ).addClass( "hide" );
$( "#352" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='352'){

$( "#350" ).removeClass( "show" ).addClass( "hide" );
...
else if(app_status=='353'){

$( "#350" ).removeClass( "show" ).addClass( "hide" );
$( "#351" ).removeClass( "show" ).addClass( "hide" );
$( "#352" ).removeClass( "show" ).addClass( "hide" );
$( "#353" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='354'){

$( "#350" ).removeClass( "show" ).addClass( "hide" );
$( "#351" ).removeClass( "show" ).addClass( "hide" );
$( "#352" ).removeClass( "show" ).addClass( "hide" );
$( "#353" ).removeClass( "show" ).addClass( "hide" );
$( "#354" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
