                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                             <?php foreach($waem as $wa){ ?>
                                            <tr>
                                                <td><?php echo $wa['id'];?></td>

                                                <td><?php echo $wa['fname'];?></td>
                                                <td><?php echo $wa['lname'];?></td>
                                               
                                                <td><?php echo $wa['dob'];?></td>
                                                 <td><?php echo $wa['phone_number'];?></td>

                                                   <td><?php echo $wa['email'];?></td>
                                                    <td><?php echo $wa['insert_on'];?></td>
                                                    <td><a href="<?php echo base_url();?>/Siaportal/wae/<?php  echo $wa['id'];?>">Full view</a> 
                                                      <a href="<?php echo base_url();?>/Siaportal/edit_wae/<?php  echo $wa['id'];?>">Edit</a></td>
