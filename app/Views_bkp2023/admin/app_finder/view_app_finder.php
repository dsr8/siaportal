            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View Application Finder</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <th>Sia Portal id</th>
                                                 ...
                                                 <th>Application Number</th>
                                                  <th>GC KEY username</th>
                                                   <th>GC KEY password</th>
                                        ...
                                        <tbody>
                                             <?php foreach($app_finder as $nf){ ?>
                                            <tr>
                                                <td><?php echo $nf['id'];?></td>
                                                <td><?php echo $nf['siaportalid'];?></td>
                                                <td><?php echo $nf['name'];?></td>
                                                 <td><?php echo $nf['application_number'];?></td>
                                                 <td><?php echo $nf['gc_username'];?></td>
                                                 <td><?php echo $nf['gc_password'];?></td>
                                                  <td><?php echo $nf['app_sub_date'];?></td>
                                                
                                                 <td><?php echo $nf['ct'];?></td>

                                              
                                                <td><?php echo $nf['ty'];?></td>
                                               
                                                <td><?php echo $nf['st'];?></td>
