...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit intl stu spousal open wp</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Intl_stu_spousal_open_wp_outland/edit_intl_stu_spousal_open_wp_outland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="45">Application in Process</option>
           <?php } elseif($app_st=='45'){ ?>
        <option value="56">Documents Awaiting for Submission</option>
           <?php } elseif($app_st=='56'){ ?>
        <option value="57">Application Submitted</option>    
           <?php } elseif($app_st=='57'){ ?>        
        <option value="58">Biometric Requested</option> 
           <?php } elseif($app_st=='58'){ ?> 
        <option value="59">Biometric Completed</option> 
           <?php } elseif($app_st=='59'){ ?>         
        <option value="60">Interview/ADR Requested</option>   
           <?php } elseif($app_st=='60'){ ?>         
        <option value="61">Interview/ADR Completed</option> 
           <?php } elseif($app_st=='61'){ ?>           
        <option value="62">Medical Request Received</option> 
           <?php } elseif($app_st=='62'){ ?>           
        <option value="63">Passport Request Received</option> 
           <?php } elseif($app_st=='63'){ ?>           
        <option value="64">Approved</option> 
        <option value="65">Refused</option>
      ...
      <?php } ?>
                  ...
                  <!--/Table Style-->
                        ...
                        <div class="row">
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="45" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
 ...
 <input  class="form-control"  name="doc_rec" id="doc_rec"  type="text" placeholder="Enter Document Received" value="<?php  echo $dddd= $cpm['0']['doc_rec']; ?>"  readonly="readonly"  />
</div>
 ...
 <input  class="form-control"  name="team_college_transfer" id="team_college_transfer"  type="text" placeholder="Enter Assigned team member for college transfer" value="<?php  echo $dddd= $cpm['0']['team_college_transfer']; ?>"    />
</div>
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter study permit expiry date" value="<?php echo $cpm['0']['study_permit_exp'];?>"  readonly="readonly"  />
</div>
<div class="form-group hide" id="3">
 ...
 <input  class="form-control"  name="date_doc_to_team" id="date_doc_to_team"  type="text" placeholder="Enter Expected Date to apply" value="<?php  echo $dddd= $cpm['0']['date_doc_to_team']; ?>"  readonly="readonly"  />
</div>
...
<!----->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="56" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_date" id="doc_req_date"  type="text" placeholder="Enter document requested date"  value="<?php echo $cpm['0']['doc_req_date'];?>"     readonly="readonly"  />
</div>
 ...
 <input  class="form-control"  name="fee_amount" id="fee_amount"  type="text" placeholder="Enter Amount"    value="<?php echo $cpm['0']['fee_amount'];?>"  />
</div>
<div class="form-group">
 <label class="small mb-1" for="inputFirstName">Fee Paid Invoice Number</label>
 <input  class="form-control"  name="fee_inv_no" id="fee_inv_no"  type="text" placeholder="Enter Fee paid invoice number"    value="<?php echo $cpm['0']['fee_inv_no'];?>"  />
</div>
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="57" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" id="app_sub_date" name="app_sub_date" class="form-control" placeholder="Application submitted Date" value="<?php echo $cpm['0']['app_sub_date'];?>"/>
</div>
 ...
 <input type="text" name="confirm_with" id="confirm_with"  placeholder="Enter confirm with" class="form-control">
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="58"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<label class="small mb-1" for="inputFirstName">Date Of Biometric received</label><!--date line-->
 <input type="text" name="date_bio_reciv" id="date_bio_reciv" class="form-control" readonly=""   placeholder="Enter Date Of Biometric received" value="<?php echo $cpm['0']['date_bio_reciv'];?>"  />
</div>
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control"readonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
</div>
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="59" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<input type="text" class="form-control" name="date_bio_comp"  id="date_bio_comp" placeholder="Date Of Biometric completed"  readonly="" value="<?php echo $cpm['0']['date_bio_comp'];?>"    />
</div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 mb-6">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
  <textarea class="form-control" name="bio_com_note"  id="bio_com_note" ><?php echo $cpm['0']['bio_com_note'];?>"</textarea>
</div>
                  </div>
  ...
  <!--section End -->
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="60" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<input type="text"   name="date_int_sent_client" id="date_int_sent_client"  placeholder="Enter Date Of Request Sent To Client" class="form-control" readonly="" value="<?php echo $cpm['0']['date_int_sent_client'];?>" >
 ...
 <input type="file"  name="int_req_upload" id="int_req_upload"   >
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="61" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="file" name="int_sub_to_ircc" id="int_sub_to_ircc"      />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="62" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <label class="small mb-1" for="inputFirstName">Date For Medical</label>
  <input type="text" name="date_for_medical" id="date_for_medical"  placeholder="Enter date for medical"  class="form-control"  readonly=""  value="<?php echo $cpm['0']['date_for_medical'];?>" />
</div>
 ...
 <input type="file" name="medical_submit" id="medical_submit"    />
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="63" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="pass_req_date" id="pass_req_date" class="form-control"  placeholder="Enter Application Number"   />
</div>
 ...
 <input type="hidden" name="passport_upload_old" id="passport_upload_old" value="">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="64" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
 ...
 <input type="text" name="date_work_permit" id="date_work_permit"  placeholder="Enter Date Of Work Permit  Received Until"  class="form-control"  readonly=""  />
</div>
 ...
 <input type="hidden" name="approval_letter_old" id="approval_letter_old"  value="<?php echo $cpm['0']['approval_letter'];?>"  />
    ...
    <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Note's</label>
 <textarea name="approve_note" id="approve_note" placeholder="Enter Note's" class="form-control" ></textarea>
</div> 
...
<!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="65" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  class="form-control" name="refusal_date"  id="refusal_date" class="form-control"  placeholder="Enter Date Of Refusal"  readonly=""   />
</div>
...
$(document).ready(function () {
 ...
 retainer_app: "Please Select Yes Or No",
        ...
        fee_inv_no: "Fee paid invoice number IS Required",
        ...
        refusal_letter: "Refusal letter IS Required",
         ...
         passport_upload: "Passport Request date Required",
        pass_req_date: "Passport Upload IS Required",
...
if(app_status=='45'){  
$( "#45" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='56'){
$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='57'){

$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );

$( "#57" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='58'){

$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='59'){

$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "show" ).addClass( "hide" );
$( "#59" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='60'){

$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "show" ).addClass( "hide" );
$( "#59" ).removeClass( "show" ).addClass( "hide" );
$( "#60" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='61'){
$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "show" ).addClass( "hide" );
$( "#59" ).removeClass( "show" ).addClass( "hide" );
$( "#60" ).removeClass( "show" ).addClass( "hide" );
$( "#61" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='62'){
$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "show" ).addClass( "hide" );
$( "#59" ).removeClass( "show" ).addClass( "hide" );
$( "#60" ).removeClass( "show" ).addClass( "hide" );  
$( "#61" ).removeClass( "show" ).addClass( "hide" );
$( "#62" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='63'){
  $( "#45" ).removeClass( "show" ).addClass( "hide" );
  $( "#56" ).removeClass( "show" ).addClass( "hide" );
  $( "#57" ).removeClass( "show" ).addClass( "hide" );
  $( "#58" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#60" ).removeClass( "show" ).addClass( "hide" );
  $( "#61" ).removeClass( "show" ).addClass( "hide" );
  $( "#62" ).removeClass( "show" ).addClass( "hide" );
  $( "#63" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='64'){
$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "show" ).addClass( "hide" );
...
$( "#61" ).removeClass( "show" ).addClass( "hide" );
$( "#62" ).removeClass( "show" ).addClass( "hide" );
$( "#63" ).removeClass( "show" ).addClass( "hide" );
$( "#64" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='65'){
$( "#45" ).removeClass( "show" ).addClass( "hide" );
$( "#56" ).removeClass( "show" ).addClass( "hide" );
$( "#57" ).removeClass( "show" ).addClass( "hide" );
$( "#58" ).removeClass( "show" ).addClass( "hide" );
...
$( "#62" ).removeClass( "show" ).addClass( "hide" );
$( "#63" ).removeClass( "show" ).addClass( "hide" );
$( "#64" ).removeClass( "show" ).addClass( "hide" );
$( "#65" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
