...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Canadian exp class express entry</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Canadian_exp_class/edit_canadian_exp_class/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="18">Assign Team Member</option> 
 <?php } else if ($cpm['0']['application_status']==18) { ?> 
          <option value="15">Profile in process</option> 
           <?php } else if ($cpm['0']['application_status']==15) { ?> 
          <option value="16">Profile created</option>
           <?php } else if ($cpm['0']['application_status']==16) { ?> 
           <option value="17">Profile submitted</option> 

         <!---profle in --->
        
        <?php } else if ($cpm['0']['application_status']==17) { ?> 
       
        <option value="19">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==19) { ?> 
        <option value="20">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==20) { ?> 
         <option value="21">Approved</option> 
         <option value="22">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="18" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
          ...
          <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="15" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="gc_password" id="gc_password"  type="text" placeholder="Enter GC KEY password" value="<?php echo $cpm['0']['gc_password'];?>"    />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="16" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <input type="text" name="log_in_info" id="log_in_info"  value="<?php echo $cpm['0']['log_in_info_pnp'];?>" placeholder="Enter log in info PNP" class="form-control"    />
  ...
  <!--section End -->
          ...
          <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="17" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="gc_password" id="gc_password"  type="text" placeholder="Enter GC KEY password" value="<?php echo $cpm['0']['gc_password'];?>"    />
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="19" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="20" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="22" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="21" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='18'){  
$( "#18" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='15'){
$( "#18" ).removeClass( "show" ).addClass( "hide" );
$( "#15" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='16'){
$( "#18" ).removeClass( "show" ).addClass( "hide" );
$( "#15" ).removeClass( "show" ).addClass( "hide" );
$( "#16" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='17'){
$( "#18" ).removeClass( "show" ).addClass( "hide" );
$( "#15" ).removeClass( "show" ).addClass( "hide" );
$( "#16" ).removeClass( "show" ).addClass( "hide" );
$( "#17" ).removeClass( "hide" ).addClass( "show" );

}

else if(app_status=='19'){
$( "#18" ).removeClass( "show" ).addClass( "hide" );
$( "#15" ).removeClass( "show" ).addClass( "hide" );
$( "#16" ).removeClass( "show" ).addClass( "hide" );
$( "#17" ).removeClass( "show" ).addClass( "hide" );

$( "#19" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='20'){
...
$( "#19" ).removeClass( "show" ).addClass( "hide" );

$( "#20" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
...
$( "#19" ).removeClass( "show" ).addClass( "hide" );
$( "#20" ).removeClass( "show" ).addClass( "hide" );
$( "#22" ).removeClass( "show" ).addClass( "hide" );
$( "#21" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
...
$( "#19" ).removeClass( "show" ).addClass( "hide" );
$( "#20" ).removeClass( "show" ).addClass( "hide" );
$( "#21" ).removeClass( "show" ).addClass( "hide" );
$( "#22" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
