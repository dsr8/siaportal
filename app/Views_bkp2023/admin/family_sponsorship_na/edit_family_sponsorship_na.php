            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Family sponsorship na</h1>
...
if($app_st=='35'){ ?>
        ...
        <option value="370">Assign Team Member</option> 
          <?php } elseif($app_st=='370'){ ?> 
        <option value="371">Application in Process</option>
          <?php } elseif($app_st=='371'){ ?> 
        <option value="372">Application Submitted</option> 
          <?php } elseif($app_st=='372'){ ?> 
         
         <option value="373">Approved</option> 
         <option value="374">Refused</option> 
...
<?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="370" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="371" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="372" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="374" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="373" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='370'){  
$( "#370" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='371'){
$( "#370" ).removeClass( "show" ).addClass( "hide" );
$( "#371" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='372'){

$( "#370" ).removeClass( "show" ).addClass( "hide" );

$( "#371" ).removeClass( "show" ).addClass( "hide" );

$( "#372" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='373'){

$( "#370" ).removeClass( "show" ).addClass( "hide" );
$( "#371" ).removeClass( "show" ).addClass( "hide" );
$( "#372" ).removeClass( "show" ).addClass( "hide" );
$( "#373" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='374'){

$( "#370" ).removeClass( "show" ).addClass( "hide" );
$( "#371" ).removeClass( "show" ).addClass( "hide" );
$( "#372" ).removeClass( "show" ).addClass( "hide" );
$( "#373" ).removeClass( "show" ).addClass( "hide" );
$( "#374" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
