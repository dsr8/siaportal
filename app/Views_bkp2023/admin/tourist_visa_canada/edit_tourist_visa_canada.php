...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Toutist visa canada</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Tourist_visa_canada/edit_toutist_visa_canada/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        <option value="326">Assign Team Member</option> 
          <?php } else if ($cpm['0']['application_status']==326) { ?> 
        <option value="119">Application in Process</option>
          <?php } else if ($cpm['0']['application_status']==119) { ?> 
           
        <option value="120">Documents Awaiting For Submission</option>  
          <?php } else if ($cpm['0']['application_status']==120) { ?> 
         
        <option value="122">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==122) { ?>            
        <option value="123">Biometric Requested</option>  
          <?php } else if ($cpm['0']['application_status']==123) { ?>           
        <option value="124">Biometric Completed</option>  
          <?php } else if ($cpm['0']['application_status']==124) { ?> 
         <option value="125">Interview/ADR Requested </option> 
           <?php } else if ($cpm['0']['application_status']==125) { ?>  
                   
        <option value="126">Interview/ADR Completed</option> 
          <?php } else if ($cpm['0']['application_status']==126) { ?>            
      
         <option value="127">Approved</option> 
          <option value="128">Refused</option> 
          <?php }?>
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="119" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="120" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="122" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="123"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control"readonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="124" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea class="form-control" name="bio_com_note"  id="bio_com_note" ><?php echo $cpm['0']['bio_com_note'];?>"</textarea>
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="125" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="126" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="127" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="128" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
<hr style="color:gray"></hr>
 ...
 <textarea name="free_text" id="free_text"value="<?php echo $cpm['0']['free_text'];?>" placeholder="Enter Note's" class="form-control" ><?php echo $cpm['0']['free_text'];?></textarea>
  ...
  <!--section End -->Account(Remaining Amount :-<?php
...
else if(app_status=='119'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#119" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='120'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );

$( "#119" ).removeClass( "show" ).addClass( "hide" );

$( "#120" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='122'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#119" ).removeClass( "show" ).addClass( "hide" );
$( "#120" ).removeClass( "show" ).addClass( "hide" );
$( "#122" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='123'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#119" ).removeClass( "show" ).addClass( "hide" );
$( "#120" ).removeClass( "show" ).addClass( "hide" );
$( "#122" ).removeClass( "show" ).addClass( "hide" );
$( "#123" ).removeClass( "hide" ).addClass( "show" );
}
