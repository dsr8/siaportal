...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Spausal Sponsorship Inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Spausal_sponsorship_inland/edit_spausal_sponsorship_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="326">Assign Team Member</option> 
         <?php } elseif($app_st=='326'){ ?>
       <option value="23">Application in Process</option>
        <?php } elseif($app_st=='23'){ ?>
       <option value="327">Documents Awaiting For Submission</option> 
        <?php } elseif($app_st=='327'){ ?>
        <option value="24">Application Submitted</option>
         <?php } elseif($app_st=='24'){ ?>
        <option value="25">Biometric Requested</option>  
         <?php } elseif($app_st=='25'){ ?>          
        <option value="26">Biometric Completed</option>  
         <?php } elseif($app_st=='26'){ ?>
        <option value="27">Medical Requested</option> 
         <?php } elseif($app_st=='27'){ ?>         
        <option value="28">Medical Completed</option>  
         <?php } elseif($app_st=='28'){ ?>          
        <option value="29">Adr IRCC</option> 
         <?php } elseif($app_st=='29'){ ?>           
        <option value="30">Interview/ADR Requested</option>
         <?php } elseif($app_st=='30'){ ?>
        <option value="31">Interview/ADR complet</option>   
         <?php } elseif($app_st=='31'){ ?>         
                 
        <option value="32">Passport Requested</option> 
         <?php } elseif($app_st=='32'){ ?>
        <option value="33">Approved</option> 
         <option value="34">Refused</option> 
       <?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="326" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="23" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="app_recv" id="app_recv"  type="text" placeholder="Enter date of application received" value="<?php echo $cpm['0']['app_recv'];?>"  readonly="readonly"  />
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Information/Checklist sent on</label>
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter study permit expiry date" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="327" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter document requested date" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
</div>
...
<!--section Start -->
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="24" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <textarea name="client_card_note" id="client_card_note"  placeholder="Enter reason" class="form-control">?php echo $cpm['0']['client_card_note'];?></textarea>  
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="25"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<label class="small mb-1" for="inputFirstName">Date Of Biometric received</label><!--date line-->
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control"readonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="26" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="27" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="28" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea name="medical_sub_note" id="medical_sub_note" class="form-control"  placeholder="Enter note's"  ><?php echo $cpm['0']['medical_sub_note'];?></textarea>
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="29" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >ADR IRCC</h2>
                <div class="table-tabs">
 ...
 <input  class="form-control" name="adr_submission_date"  id="adr_submission_date" class="form-control"  placeholder="Enter submission date" readonly="" value="<?php echo $cpm['0']['adr_submission_date'];?>"   />
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="30" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="31" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="32" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="pp_tentative" id="pp_tentative" value="<?php echo $cpm['0']['pp_tentative'];?>" class="form-control" placeholder="Enter PP submition tentative"   readonly=""  />
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="34" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="33" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
else if(app_status=='23'){
 
$( "#326" ).removeClass("show").addClass("hide");
$( "#23" ).removeClass("hide").addClass("show");

}

else if(app_status=='327'){
 
$( "#326" ).removeClass("show").addClass("hide");
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("hide").addClass("show");

}

else if(app_status=='24'){
  
$( "#326" ).removeClass("show").addClass("hide");
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass("hide").addClass("show");
$("#note").prop('required',true);
 $("p").css("color", "red");

}
else if(app_status=='25'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
$( "#25" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='26'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
$( "#25" ).removeClass( "show" ).addClass( "hide" );
$( "#26" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='27'){
...
$( "#24" ).removeClass( "show" ).addClass( "hide" );
$( "#25" ).removeClass( "show" ).addClass( "hide" );
$( "#26" ).removeClass( "show" ).addClass( "hide" );
$( "#27" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='28'){
...
$( "#25" ).removeClass( "show" ).addClass( "hide" );
$( "#26" ).removeClass( "show" ).addClass( "hide" );
$( "#27" ).removeClass( "show" ).addClass( "hide" );
$( "#28" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='29'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
...
$( "#26" ).removeClass( "show" ).addClass( "hide" );
$( "#27" ).removeClass( "show" ).addClass( "hide" );
$( "#28" ).removeClass( "show" ).addClass( "hide" );
$( "#29" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='30'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
...
$( "#27" ).removeClass( "show" ).addClass( "hide" );
$( "#28" ).removeClass( "show" ).addClass( "hide" );  
$( "#29" ).removeClass( "show" ).addClass( "hide" );
$( "#30" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='31'){
  $( "#326" ).removeClass( "show" ).addClass( "hide" );
  $( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
  $( "#24" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#28" ).removeClass( "show" ).addClass( "hide" );
  $( "#29" ).removeClass( "show" ).addClass( "hide" );
  $( "#30" ).removeClass( "show" ).addClass( "hide" );
  $( "#31" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='32'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
...
$( "#29" ).removeClass( "show" ).addClass( "hide" );
$( "#30" ).removeClass( "show" ).addClass( "hide" );
$( "#31" ).removeClass( "show" ).addClass( "hide" );
$( "#32" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='33'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
...
$( "#30" ).removeClass( "show" ).addClass( "hide" );
$( "#31" ).removeClass( "show" ).addClass( "hide" );
$( "#32" ).removeClass( "show" ).addClass( "hide" );
$( "#33" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='34'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#23" ).removeClass("show").addClass("hide");
$( "#327" ).removeClass("show").addClass("hide");
$( "#24" ).removeClass( "show" ).addClass( "hide" );
...
$( "#31" ).removeClass( "show" ).addClass( "hide" );
$( "#32" ).removeClass( "show" ).addClass( "hide" );
$( "#33" ).removeClass( "show" ).addClass( "hide" );
$( "#34" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
