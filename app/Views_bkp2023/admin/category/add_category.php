            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_category"> 
                        <div class="row">
                             <div class="col-xl-3 col-md-3"></div>
                            <div class="col-xl-6 col-md-6">
                                
<div class="form-group"><label class="small mb-1" for="inputFirstName"> Category</label>
    <input class="form-control py-4" name="category" id="category" type="text" placeholder="Enter Category" /></div>
