...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit new public policy for PR inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/New_public_policy_for_PR/edit_new_public_policy_for_PR_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
         ...
         <option value="587">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==587) { ?> 
       
        <option value="588">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==588) { ?> 
        
         <option value="589">Application Completed</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="587" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="588" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="332" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="334" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="589" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                ...
                <div class="table-tabs">
                  ...
                  <section class="section-preview">
                    ...
                    <div style="padding: 1px;   float:left;height:auto;width:100%">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Date Of Application Completed </label>
 <input type="text" name="date_work_permit" id="date_work_permit"  placeholder="Enter Date Of Approval"  class="form-control" value="<?php echo $cpm['0']['date_work_permit'];?>" readonly=""  />
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 mb-4">
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName"> Letter Upload</label>
...
$( "#587" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='588'){
$( "#587" ).removeClass( "show" ).addClass( "hide" );
$( "#588" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='589'){

$( "#587" ).removeClass( "show" ).addClass( "hide" );

$( "#588" ).removeClass( "show" ).addClass( "hide" );

$( "#589" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
