            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View Student Need Job</h1>
                ...
                <th style="width:10px;">Taggs for Search/Comment</th>
                ...
                <?php foreach($emp_for_student as $allcat) { ?>
...
if($allcat['voice_added']=='siaportal'){
 ...
 <?php } else {?>
                  ...
                  <td style="width:5px;"><?php echo $allcat['heading'];?> </td>
                   <td style="width:5px;"><?php echo $allcat['tag_search'];?><?php echo $allcat['s_com'];?> </td>
              <td style="width:5px;"><?php echo $allcat['having_canada_visa'];?> </td>
                  ...
                  <td style="width:5px;"> <?php echo $allcat['agent_name'];?></td>
                   <td style="width:5px;"> <?php echo $allcat['source'];?></td>
...
<?php } else { ?> <?php } ?>
                   ...
                   <td style="width:5px;"><a href ="<?php echo base_url();?>/Siaportal/edit_student_need_job/<?php echo $allcat['id'];?>">Edit</a></td>
