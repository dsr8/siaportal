...
<html lang="en">
    <head>
        ...
        <title>Siaportal</title>
      	<link href="https://canada.siaimmigration.com/public/dist/css/styles.css" rel="stylesheet" />
  ...
  <div class="row">
    ...
    <div class="offset-6 col-md-6">
      ...
      <div class="main-login-form">
        <h3>Login</h3>
        <hr>
        <?php if (session()->get('isIn')==true) { ?>
          <div class="alert alert-danger" role="alert">
          Email address or password incorrect
          </div>
        <?php } ?>
        <form class="" action="<?php  base_url();?>/Siaportal/login" method="post">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-8 text-right">
              <a href="<?php  base_url();?>/Siaportal/forget_pass">Forgot Password?</a>
            </div>
          </div>
        </form>
      </div>
