...
<script>
    ...
    $('.add_more_button').click(function(e){ //click event on add more fields button having class add_more_button
        ...
        if(x < max_fields_limit){ //check conditions
            x++; //counter increment
            $('.input_fields_container').append('<div><div class="form-group"> <label class="col-md-4 control-label" for="action_id">Document name</label> <div class="col-md-8"> <input id="doc_name" name="doc_name[]" type="text" placeholder="" class="form-control input-md" required> </div></div><!--hhhhhhh--> <!-- Text input--></br><div class="form-group" > <label class="col-md-4 control-label" for="action_name">Upload Document</label> <div class="col-md-8"> <input style="    margin-top: 10px;" id="resume" name="resume[]" type="file" placeholder="" class=" input-md" required> </div></div><!-- File Button --> <a href="#" class="remove_field btn btn-danger remove-me" style="margin-left:10px;">Remove</a></div>'); //add input field
        }
    });  
