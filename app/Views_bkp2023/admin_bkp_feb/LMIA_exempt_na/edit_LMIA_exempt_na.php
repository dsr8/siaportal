...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit LMIA exempt na</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/LMIA_exempt_na/edit_LMIA_exempt_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="559">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==559) { ?> 
       
        <option value="560">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==560) { ?> 
        <option value="561">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==561) { ?> 
         <option value="562">Approved</option> 
         <option value="564">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="559" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="560" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="561" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="564" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
...
$poa=$acc['0']['pay_one_amount'];
 ...
 <input type="radio" name="govt_fee" id="govt_fee" <?php if($acc['0']['govt_fee']=='td_sia'){ echo "checked=checked"; } else{echo "";}  ?>    value="td_sia" /> Td Sia
  <input type="radio" name="govt_fee" id="govt_fee" <?php if($acc['0']['govt_fee']=='Client_own'){ echo "checked=checked";} else{echo "";}  ?>   value="Client_own" /> Client own
  <input type="radio" name="govt_fee" id="govt_fee" <?php if($acc['0']['govt_fee']=='tbd'){ echo "checked=checked";} else{echo "";} ?>   value="tbd" /> Tbd
</div>
...
if(app_status=='559'){  
$( "#559" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='560'){
$( "#559" ).removeClass( "show" ).addClass( "hide" );
$( "#560" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='561'){

$( "#559" ).removeClass( "show" ).addClass( "hide" );

$( "#560" ).removeClass( "show" ).addClass( "hide" );

$( "#561" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='562'){

$( "#559" ).removeClass( "show" ).addClass( "hide" );
$( "#560" ).removeClass( "show" ).addClass( "hide" );
$( "#561" ).removeClass( "show" ).addClass( "hide" );
$( "#562" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='564'){

$( "#559" ).removeClass( "show" ).addClass( "hide" );
$( "#560" ).removeClass( "show" ).addClass( "hide" );
$( "#561" ).removeClass( "show" ).addClass( "hide" );
$( "#562" ).removeClass( "show" ).addClass( "hide" );
$( "#564" ).removeClass( "hide" ).addClass( "show" );
}
