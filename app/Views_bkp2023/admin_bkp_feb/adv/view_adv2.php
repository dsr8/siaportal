            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View Advertisement</h1>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Ingenious Start Date</th>
                                                 <th>Ingenious End Date</th>

                                                <th>Kijiji Start Date</th>
                                                  <th>Kijiji End Date</th>
                                                
                                                  <th>Craigslist Start Date</th>
                                                   <th>Craigslist End Date</th>


                                                   <th>Other Start Date</th>
                                                   <th>Other End Date</th>
                                            </tr>
                                        </thead>
                                        
                                        <tbody>
                                             <?php foreach($adv2 as $nf){ ?>
                                            <tr>
                                                <td><?php echo $nf['id'];?></td>

                                                <td><?php echo $nf['stt_il_start_date'];?></td>
                                                 <td><?php echo $nf['stt_il_end_date'];?></td>

                                                   <td><?php echo $nf['stt_ki_start_date'];?></td>
                                                 <td><?php echo $nf['stt_ki_end_date'];?></td>

                                                   <td><?php echo $nf['stt_ca_start_date'];?></td>
                                                 <td><?php echo $nf['stt_ca_end_date'];?></td>

                                                  <td><?php echo $nf['stt_oa_start_date'];?></td>
                                                 <td><?php echo $nf['stt_oa_end_date'];?></td>
