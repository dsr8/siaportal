            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View Referred Client</h1>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                  <td><?php echo $value['id']; ?></td>
                                                   <td><?php echo $value['siaprotal_id']; ?></td>
                                                  <td><?php echo $value['heading']; ?></td>
                                                     <td><?php echo $value['email']; ?></td>
                                                 <td><?php echo $value['number']; ?></td>
                                                  <td><?php echo $value['refer_staus']; ?></td>
                                               <td><a href="<?php echo base_url();?>/Siaportal/edit_refer_client/<?php echo $value['id'];?>">Edit</a></td>
