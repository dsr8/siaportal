            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_agent"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Contact Number</label>
    <input class="form-control py-4" name="mobile_no" id="mobile_no" type="text" placeholder="Enter Contact Number" /></div>
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Country</label><input class="form-control py-4" id="country" type="text" name="country" placeholder="Enter Country" required="required" /></div>
<div class="form-group"><label c'lass="small mb-1" for="inputFirstName">Commission %</label><input class="form-control py-4" id="commision" type="text" name="commision" placeholder="Enter Commission %" /></div>



<div class="form-group"><label class="small mb-1" for="inputFirstName">Referral fee</label><input class="form-control py-4" id="reff" type="text"name="reff" placeholder="Enter Referral fee" /></div>
                            </div>
        ...
        name: "Name Is required",
         mobile_no: "Contact number Is required",
          email: "Email Is required",
           ...
           commision: "Commission Is required",
           reff: "Referral fee Is required",
