...
//exit();
        ...
        <!--option value="35">Ready To Apply</option--> 
         <option value="395">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==395) { ?> 
       
        <option value="396">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==396) { ?> 
        <option value="397">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==397) { ?> 
         <option value="398">Approved</option> 
         <option value="399">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="395" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="396" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="397" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="399" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="398" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='395'){  
$( "#395" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='396'){
$( "#395" ).removeClass( "show" ).addClass( "hide" );
$( "#396" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='397'){

$( "#395" ).removeClass( "show" ).addClass( "hide" );

$( "#396" ).removeClass( "show" ).addClass( "hide" );

$( "#397" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='398'){

$( "#395" ).removeClass( "show" ).addClass( "hide" );
$( "#396" ).removeClass( "show" ).addClass( "hide" );
$( "#397" ).removeClass( "show" ).addClass( "hide" );
$( "#398" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='399'){

$( "#395" ).removeClass( "show" ).addClass( "hide" );
$( "#396" ).removeClass( "show" ).addClass( "hide" );
$( "#397" ).removeClass( "show" ).addClass( "hide" );
$( "#398" ).removeClass( "show" ).addClass( "hide" );
$( "#399" ).removeClass( "hide" ).addClass( "show" );
}
