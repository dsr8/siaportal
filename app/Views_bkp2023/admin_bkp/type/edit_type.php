            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/edit_type/<?php echo $type['0']['id'];?>"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Category</label>
    <select class="form-control"NAME="category_id">
        <option value="<?php echo $typedata['0']['category_id'];?>"><?php echo $typedata['0']['ct']; ?></option>
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Type</label>
    <input class="form-control py-4" name="type" id="type" type="text"  value="<?php echo $type['0']['type'];?>"placeholder="Enter type" /></div>
