...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Lmia pr Low Wage</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Lmia_pr_lg/edit_lmia_pr_low_wage/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="452">Assign Team Member</option> 
          <?php } elseif($app_st=='452'){ ?>  
        <option value="441">Application In Process</option>
          <?php } elseif($app_st=='441'){ ?>  
        <option value="453">Information Requested For Advertisement</option>
          <?php } elseif($app_st=='453'){ ?>  
        <option value="217">Advertisement Started</option>  
          <?php } elseif($app_st=='217'){ ?>            
        <option value="215">Documents Awaiting For Submission</option> 
          <?php } elseif($app_st=='215'){ ?>   
        <option value="454">Advertisement Renewal 1st Stage</option> 
          <?php } elseif($app_st=='454'){ ?>           
        <option value="218">Application Submitted</option> 
          <?php } elseif($app_st=='218'){ ?>             
        <option value="219">LMIA Number Received</option>   
          <?php } elseif($app_st=='219'){ ?>           
        <option value="220">Interview/ADR Requested</option>  
          <?php } elseif($app_st=='220'){ ?>            
        <option value="221">Interview/ADR Completed</option> 
          <?php } elseif($app_st=='221'){ ?>             
        <option value="455">Advertisement Renewal 2nd Stage</option> 
          <?php } elseif($app_st=='455'){ ?>  
         <option value="222">Approved</option> 
          <option value="223">Refused</option> 
          <?php
        }
          ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="452" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="453" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea  class="form-control"  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Advertisement Fees Paid Invoice Number" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="217" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="ad_oa_end_date" id="ad_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="215" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="454" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="st_oa_end_date" id="st_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="218" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="219"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="lmia_number" id="lmia_number" placeholder="Enter LMIA Number" class="form-control"readonly="" value="<?php echo $cpm['0']['lmia_number'];?>">
</div>
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="220" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="221" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="455" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="stt_oa_end_date" id="stt_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="223" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="222" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='452'){  
$( "#452" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='441'){
$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='453'){

$( "#452" ).removeClass( "show" ).addClass( "hide" );

$( "#441" ).removeClass( "show" ).addClass( "hide" );

$( "#453" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='217'){

$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='215'){

$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
$( "#215" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='454'){

$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
$( "#215" ).removeClass( "show" ).addClass( "hide" );
$( "#454" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='218'){
$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
$( "#215" ).removeClass( "show" ).addClass( "hide" );
$( "#454" ).removeClass( "show" ).addClass( "hide" );
$( "#218" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='219'){
$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
$( "#215" ).removeClass( "show" ).addClass( "hide" );
$( "#454" ).removeClass( "show" ).addClass( "hide" );  
$( "#218" ).removeClass( "show" ).addClass( "hide" );
$( "#219" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='220'){
  $( "#452" ).removeClass( "show" ).addClass( "hide" );
  $( "#441" ).removeClass( "show" ).addClass( "hide" );
  $( "#453" ).removeClass( "show" ).addClass( "hide" );
  $( "#217" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#454" ).removeClass( "show" ).addClass( "hide" );
  $( "#218" ).removeClass( "show" ).addClass( "hide" );
  $( "#219" ).removeClass( "show" ).addClass( "hide" );
  $( "#220" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='221'){
$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
...
$( "#218" ).removeClass( "show" ).addClass( "hide" );
$( "#219" ).removeClass( "show" ).addClass( "hide" );
$( "#220" ).removeClass( "show" ).addClass( "hide" );
$( "#221" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='455'){
$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
...
$( "#219" ).removeClass( "show" ).addClass( "hide" );
$( "#220" ).removeClass( "show" ).addClass( "hide" );
$( "#221" ).removeClass( "show" ).addClass( "hide" );
$( "#455" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='222'){
$( "#452" ).removeClass( "show" ).addClass( "hide" );
$( "#441" ).removeClass( "show" ).addClass( "hide" );
$( "#453" ).removeClass( "show" ).addClass( "hide" );
$( "#217" ).removeClass( "show" ).addClass( "hide" );
...
$( "#220" ).removeClass( "show" ).addClass( "hide" );
$( "#221" ).removeClass( "show" ).addClass( "hide" );
$( "#455" ).removeClass( "show" ).addClass( "hide" );
$( "#222" ).removeClass( "hide" ).addClass( "show" );
}
