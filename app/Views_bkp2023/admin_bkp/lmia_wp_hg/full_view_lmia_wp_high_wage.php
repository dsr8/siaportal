...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Full View Lmia work permit High Wage</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Lmia_global/edit_lmia_global_tlnt_high_wage/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>//<?php echo $cpm['0']['type'];?>"> 
...
<input type="hidden"  name="news_image1_old" value="<?php echo $cpm['0']['voice_msg'];?>">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="326" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly   placeholder="Enter date of application received" value="<?php echo $cpm['0']['assign_to'];?>"  readonly="readonly"  />
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="314" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
</div>
  ...
  <!--section End -->
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="315" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="info_doc_req_date" id="info_doc_req_date"  type="text" placeholder="Enter Information Received On" value="<?php echo $cpm['0']['info_doc_req_date'];?>"   readonly="readonly"  />
</div>
 ...
 <textarea  class="form-control aa" readonly  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Advertisement Fees Paid Invoice Number" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
</div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="316" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="ad_job_start_date" id="ad_job_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['ad_job_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
 ...
 <input  class="form-control aa" readonly  name="ad_job_end_date" id="ad_job_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_job_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
 ...
 <label class="small mb-1" for="inputFirstName">Ingenious Link Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="ad_il_start_date" id="ad_il_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['ad_il_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="ad_il_end_date" id="ad_il_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_il_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
 ...
 <label class="small mb-1" for="inputFirstName">Kijiji Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="ad_ki_start_date" id="ad_ki_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['ad_ki_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="ad_ki_end_date" id="ad_ki_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_ki_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
 ...
 <label class="small mb-1" for="inputFirstName">Craigslist Advertisement </label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="ad_ca_start_date" id="ad_ca_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['ad_ca_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="ad_ca_end_date" id="ad_ca_end_date"  type="text" placeholder="Enter end Date" value="<?php echo $cpm['0']['ad_ca_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
 ...
 <label class="small mb-1" for="inputFirstName">Other Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="ad_oa_start_date" id="ad_oa_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['ad_oa_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="ad_oa_end_date" id="ad_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_oa_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="317" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="doc_req_date" id="doc_req_date"  type="text" placeholder="Enter Documents Requested Date" value="<?php echo $cpm['0']['doc_req_date'];?>"   readonly="readonly"  />
</div>
 ...
 <input  class="form-control aa" readonly  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
</div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="318" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <label class="small mb-1" for="inputFirstName">Job Bank Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="st_job_start_date" id="st_job_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['st_job_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="st_job_end_date" id="st_job_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_job_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
 ...
 <label class="small mb-1" for="inputFirstName">Ingenious Link Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="st_il_start_date" id="st_il_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['st_il_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="st_il_end_date" id="st_il_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_il_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
 ...
 <label class="small mb-1" for="inputFirstName">Kijiji Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="st_ki_start_date" id="st_ki_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['st_ki_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="st_ki_end_date" id="st_ki_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_ki_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
 ...
 <label class="small mb-1" for="inputFirstName">Craigslist Advertisement </label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="st_ca_start_date" id="st_ca_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['st_ca_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="st_ca_end_date" id="st_ca_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_ca_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
 ...
 <label class="small mb-1" for="inputFirstName">Other Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="st_oa_start_date" id="st_oa_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['st_oa_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="st_oa_end_date" id="st_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_oa_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="319" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <label class="small mb-1" for="inputFirstName">Mode Of payment by client</label><br>
  <select class="form-control aa" readonly name="mode_client_payment">
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control aa" readonly placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="320"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="lmia_rec_date" id="lmia_rec_date" class="form-control aa" readonly readonly=""   placeholder="Enter Date Of Biometric received" value="<?php echo $cpm['0']['lmia_rec_date'];?>"  />
</div>
 ...
 <input type="text" name="lmia_number" id="lmia_number" placeholder="Enter LMIA Number" class="form-control aa" readonlyreadonly="" value="<?php echo $cpm['0']['lmia_number'];?>">
</div>
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="321" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="322" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="323" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <label class="small mb-1" for="inputFirstName">Job Bank Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="stt_job_start_date" id="stt_job_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['stt_job_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="stt_job_end_date" id="stt_job_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_job_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
 ...
 <label class="small mb-1" for="inputFirstName">Ingenious Link Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="stt_il_start_date" id="stt_il_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['stt_il_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="stt_il_end_date" id="stt_il_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_il_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
 ...
 <label class="small mb-1" for="inputFirstName">Kijiji Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="stt_ki_start_date" id="stt_ki_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['stt_ki_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="stt_ca_end_date" id="stt_ca_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_ca_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
 ...
 <label class="small mb-1" for="inputFirstName">Craigslist Advertisement </label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="stt_ca_start_date" id="stt_ca_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['stt_ca_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
 ...
 <label class="small mb-1" for="inputFirstName">Other Advertisement</label>
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">Start Date</label>
 <input  class="form-control aa" readonly  name="stt_oa_start_date" id="stt_oa_start_date"  type="text" placeholder="Enter Start Date" value="<?php echo $cpm['0']['stt_oa_start_date'];?>"   readonly="readonly"  />
</div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                     ...
                     <div class="form-group">
 <label class="small mb-1" for="inputFirstName">End Date</label>
 <input  class="form-control aa" readonly  name="stt_oa_end_date" id="stt_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_oa_end_date'];?>"   readonly="readonly"  />
</div>
     </div>
   </div>
                  </div>
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="325" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control aa" readonly  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
</div>  
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="324" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
 ...
 <input type="text" name="date_work_permit" id="date_work_permit"  placeholder="Enter Date Of Work Permit  Received Until"  class="form-control aa" readonly value="<?php echo $cpm['0']['date_work_permit'];?>" readonly=""  />
</div>
...
if(app_status=='326'){  
$( "#326" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='314'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='315'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );

$( "#314" ).removeClass( "show" ).addClass( "hide" );

$( "#315" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='316'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='317'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
$( "#317" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='318'){

$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
$( "#317" ).removeClass( "show" ).addClass( "hide" );
$( "#318" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='319'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
$( "#317" ).removeClass( "show" ).addClass( "hide" );
$( "#318" ).removeClass( "show" ).addClass( "hide" );
$( "#319" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='320'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
$( "#317" ).removeClass( "show" ).addClass( "hide" );
$( "#318" ).removeClass( "show" ).addClass( "hide" );  
$( "#319" ).removeClass( "show" ).addClass( "hide" );
$( "#320" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='321'){
  $( "#326" ).removeClass( "show" ).addClass( "hide" );
  $( "#314" ).removeClass( "show" ).addClass( "hide" );
  $( "#315" ).removeClass( "show" ).addClass( "hide" );
  $( "#316" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#318" ).removeClass( "show" ).addClass( "hide" );
  $( "#319" ).removeClass( "show" ).addClass( "hide" );
  $( "#320" ).removeClass( "show" ).addClass( "hide" );
  $( "#321" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='322'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
...
$( "#319" ).removeClass( "show" ).addClass( "hide" );
$( "#320" ).removeClass( "show" ).addClass( "hide" );
$( "#321" ).removeClass( "show" ).addClass( "hide" );
$( "#322" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='323'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
...
$( "#320" ).removeClass( "show" ).addClass( "hide" );
$( "#321" ).removeClass( "show" ).addClass( "hide" );
$( "#322" ).removeClass( "show" ).addClass( "hide" );
$( "#323" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='324'){
$( "#326" ).removeClass( "show" ).addClass( "hide" );
$( "#314" ).removeClass( "show" ).addClass( "hide" );
$( "#315" ).removeClass( "show" ).addClass( "hide" );
$( "#316" ).removeClass( "show" ).addClass( "hide" );
...
$( "#321" ).removeClass( "show" ).addClass( "hide" );
$( "#322" ).removeClass( "show" ).addClass( "hide" );
$( "#323" ).removeClass( "show" ).addClass( "hide" );
$( "#324" ).removeClass( "hide" ).addClass( "show" );
}
