...
<i class="fa fa-envelope-open" aria-hidden="true"></i><?php echo $allcat['email'];?><br>
            ...
            <lable >  <a  data-toggle="modal" data-target="#exampleModal" target="_blank" href=""><i class="fa fa-plus" aria-hidden="true"></i></a></lable><lable>
  ...
  $Query=mysqli_query($con,$SelQuery) or die(mysqli_error());
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-md-3  "  data-toggle="tooltip" title="<?php echo $GetData['cat'];?>" > 
       ...
       <div class="col-xl-12 col-md-12" style="background-color:#6b5b95; font-size: 13px;" > <i  class="fa fa-id-badge" style="color:#fff; margin-left:1px;" ></i> <?php echo $GetData['cat'];?>
...
<div  style="background-color:#feb236;font-size: 13px; ">
...
<div style="background-color:#d64161;font-size: 13px;">
