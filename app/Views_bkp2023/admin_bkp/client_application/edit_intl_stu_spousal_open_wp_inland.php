...
<?= view('admininclude/admin_nav'); ?>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Siaportal/edit_intl_stu_spousal_open_wp_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>//<?php echo $cpm['0']['type'];?>"> 
