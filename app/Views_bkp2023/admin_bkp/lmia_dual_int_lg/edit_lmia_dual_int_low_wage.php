...
<?= view('admininclude/admin_nav'); ?>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Lmia_dual_int_lg/edit_lmia_dual_int_low_wage/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="456">Assign Team Member</option> 
          <?php } elseif($app_st=='456'){ ?>  
        <option value="247">Application In Process</option>
          <?php } elseif($app_st=='247'){ ?>  
        <option value="457">Information Requested For Advertisement</option>
          <?php } elseif($app_st=='457'){ ?>  
        <option value="251">Advertisement Started</option>  
          <?php } elseif($app_st=='251'){ ?>  

        <option value="250">Documents Awaiting For Submission</option>
          <?php } elseif($app_st=='250'){ ?>   
         
        <option value="458">Advertisement Renewal 1st Stage</option>  
          <?php } elseif($app_st=='458'){ ?>          
        <option value="249">Application Submitted</option> 
          <?php } elseif($app_st=='249'){ ?>             
        <option value="253">LMIA Number Received</option>  
          <?php } elseif($app_st=='253'){ ?>            
        <option value="254">Interview/ADR Requested</option>  
          <?php } elseif($app_st=='254'){ ?>            
        <option value="255">Interview/ADR Completed</option>  
          <?php } elseif($app_st=='255'){ ?>            
        <option value="459">Advertisement Renewal 2nd Stage</option> 
          <?php } elseif($app_st=='459'){ ?>  
         <option value="256">Approved</option> 
          <option value="257">Refused</option> 
        <?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="456" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="247" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="457" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea  class="form-control"  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Advertisement Fees Paid Invoice Number" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="251" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="ad_oa_end_date" id="ad_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="250" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="458" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="st_oa_end_date" id="st_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="249" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="253"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="lmia_number" id="lmia_number" placeholder="Enter LMIA Number" class="form-control"readonly="" value="<?php echo $cpm['0']['lmia_number'];?>">
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="254" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="255" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="459" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="stt_oa_end_date" id="stt_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['stt_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="257" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="256" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='456'){  
$( "#456" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='247'){
$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='457'){

$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='251'){

$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='250'){

$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
$( "#250" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='458'){

$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
$( "#250" ).removeClass( "show" ).addClass( "hide" );
$( "#458" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='249'){
$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
$( "#250" ).removeClass( "show" ).addClass( "hide" );
$( "#458" ).removeClass( "show" ).addClass( "hide" );
$( "#249" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='253'){
$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
$( "#250" ).removeClass( "show" ).addClass( "hide" );
$( "#458" ).removeClass( "show" ).addClass( "hide" );  
$( "#249" ).removeClass( "show" ).addClass( "hide" );
$( "#253" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='254'){
  $( "#456" ).removeClass( "show" ).addClass( "hide" );
  $( "#247" ).removeClass( "show" ).addClass( "hide" );
  $( "#457" ).removeClass( "show" ).addClass( "hide" );
  $( "#251" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#458" ).removeClass( "show" ).addClass( "hide" );
  $( "#249" ).removeClass( "show" ).addClass( "hide" );
  $( "#253" ).removeClass( "show" ).addClass( "hide" );
  $( "#254" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='255'){
$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
...
$( "#249" ).removeClass( "show" ).addClass( "hide" );
$( "#253" ).removeClass( "show" ).addClass( "hide" );
$( "#254" ).removeClass( "show" ).addClass( "hide" );
$( "#244" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='459'){
$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
...
$( "#459" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='256'){
$( "#456" ).removeClass( "show" ).addClass( "hide" );
$( "#247" ).removeClass( "show" ).addClass( "hide" );
$( "#457" ).removeClass( "show" ).addClass( "hide" );
$( "#251" ).removeClass( "show" ).addClass( "hide" );
...
$( "#254" ).removeClass( "show" ).addClass( "hide" );
$( "#244" ).removeClass( "show" ).addClass( "hide" );
$( "#459" ).removeClass( "show" ).addClass( "hide" );
$( "#256" ).removeClass( "hide" ).addClass( "show" );
}
