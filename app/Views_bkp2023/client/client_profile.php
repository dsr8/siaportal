...
<input type="text" class="form-control" value="<?php echo $prof['0']['heading']; ?>" disabled>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Contact number</label>
          <input type="text" class="form-control"value="<?php echo $prof['0']['number']; ?>" disabled>
                        </div>
                      </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Spouse name</label>
                <input type="text" class="form-control" value="<?php echo $prof['0']['spouse_name']; ?>"disabled>
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Date of bith</label>
                          <input type="email" class="form-control" value="<?php echo $prof['0']['user_dob']; ?>"disabled>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="<?php echo $prof['0']['city']; ?>" disabled>
                        </div>
                      </div>
                        <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Address</label>
                          <input type="text" class="form-control" value="<?php echo $prof['0']['address']; ?>"disabled>
                        </div>
                      </div>
                    </div>
