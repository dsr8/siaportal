...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Application</a>
          </div>
  ...
  <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/document_upload" enctype="multipart/form-data"> 
     <input type="hidden" name="application_id" id="application_id" value="<?php echo $c['id']; ?>">
      <input type="hidden" name="category" id="category" value="<?php echo $c['category']; ?>">
        <input type="hidden" name="type" id="type" value="<?php echo $c['type']; ?>">
          <input type="hidden" name="status" id="status" value="<?php echo $c['application_status']; ?>">
           <input type="hidden" name="ct" id="ct" value="<?php echo $c['ct']; ?>">
            <input type="hidden" name="ty" id="ty" value="<?php echo $c['ty']; ?>">
             <input type="hidden" name="st" id="st" value="<?php echo $c['st']; ?>">

         <div class="form-group">
    <input class="form-control py-4" name="doc_name" id="doc_name" type="text" placeholder="Enter Document name" /></div>

              
    <input  name="resume" id="resume" type="file"  />


<div class="form-group"><label class="small mb-1" for="inputFirstName"></label>
...
//$ddd=$allcat['id'];
  $SelQuery = "SELECT * FROM tbl_client_document

where tbl_client_document.`application_id` =$ddd AND tbl_client_document.`upload_by`='client' "; 
   //exit();
  ...
  $Query=mysqli_query($con,$SelQuery) or die(mysqli_error());
     while($GetData=mysqli_fetch_array($Query)){
                  ...
                  <a  data-toggle="tooltip" title="<?php echo $GetData['doc_name'];?>" target="_blank" href="<?php echo $GetData['client_document_link'];?>">   <i style="font-size: 2rem;" class="fa fa-file-o" aria-hidden="true"></i></a>
                  <?php echo $GetData['doc_name'];?><br>
