      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Refund Policy</a>
          </div>
...
<p>The CLIENT acknowledges that granting of a visa or status and the time required for processing this
application is at the sole discretion of the government and not the RCIC.</p><p>
If however, the application is denied because of an error or omission on the part of the RCIC or
professional staff, the RICIC will refund all professional fees collected except the first payment stated in
clause 6 and any sums paid under clause 7. The said fees are non-refundable whatsoever. The CLIENT
agrees that the fees paid are for services indicated above, and any refund is strictly limited to the amount
of fees paid less the non-refundable fees.
The firm will not refund any of the professional fees charged and shall be entitled to full payment of</p>  <br>

<h2>professional fee as per this agreement if:</h2>

<li><i class="flaticon-login"></i>The CLIENT does not cooperate in filling the application for BCPNP (International Graduate category) with the
immigration authorities.</li>



<li><i class="flaticon-login"></i>The application gets rejected due to false information, misrepresentation, fraud, medical or security inadmissibility or
failure by the CLIENT to adhere to the terms and conditions of this agreement.</li>



<li><i class="flaticon-login"></i>The application gets rejected because of CLIENT’s withholding relevant information at any time during the processing of
the immigration application or at the time of interview with visa officer.</li>
...
<li><i class="flaticon-login"></i>CLIENT does not co-operate in the finalization of immigration case.</li>



<li><i class="flaticon-login"></i>CLIENT fails to satisfy the immigration officer of his/her truthfulness of information submitted

</li>

<li><i class="flaticon-login"></i>The application gets rejected for breaches of security, criminal convictions and pending charges.</li>
