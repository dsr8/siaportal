...
class Study_permit_extension_inland extends BaseController
{


public function edit_study_permit_extension_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/study_permit_extension_inland/edit_study_permit_extension_inland',$data);
}
}
///-------------------
...
public function edit_study_permit_extension_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/study_permit_extension_inland/edit_study_permit_extension_inland_new',$data);
}
}
///-------------------
...
public function full_study_permit_extension_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/study_permit_extension_inland/full_view_study_permit_extension_inland',$data);
}
