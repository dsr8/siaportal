...
class PGWP_extension_inland extends BaseController
{


public function edit_PGWP_extension_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/PGWP_extension_inland/edit_PGWP_extension_inland',$data);
}
}
///-------------------

//////////////new start
public function edit_PGWP_extension_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/PGWP_extension_inland/edit_PGWP_extension_inland_new',$data);
}
}
///-------------------
...
public function full_PGWP_extension_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/PGWP_extension_inland/full_view_PGWP_extension_inland',$data);
}
