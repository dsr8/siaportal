...
class Restoration_Of_Status_worker extends BaseController
{
...
////////////new start
public function edit_worker_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/restoration_of_status_worker/edit_worker_new',$data);
}
}
...
public function full_worker_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/restoration_of_status_worker/full_worker_new',$data);
