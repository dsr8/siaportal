...
class Bridging_open_wp_na extends BaseController
{


public function edit_bridging_open_wp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bridging_open_wp_na/edit_bridging_open_wp_na',$data);
}
}
///-------------------
...
public function edit_bridging_open_wp_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bridging_open_wp_na/edit_bridging_open_wp_na_new',$data);
}
}
///-------------------
...
public function full_bridging_open_wp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bridging_open_wp_na/full_view_bridging_open_wp_na',$data);
}
