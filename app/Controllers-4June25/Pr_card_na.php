...
class Pr_card_na extends BaseController
{


public function edit_pr_card_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/pr_card_na/edit_pr_card_na',$data);
}
}
///-------------------
...
public function edit_pr_card_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/pr_card_na/edit_pr_card_na_new',$data);
}
}
///-------------------
////////new end
public function full_pr_card_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/pr_card_na/full_view_pr_card_na',$data);
}
