...
class Co_op_wp extends BaseController
{


public function edit_co_op_wp($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/co_op_wp/edit_co_op_wp',$data);
}
}
///-------------------
//////////new start
public function edit_co_op_wp_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/co_op_wp/edit_co_op_wp_new',$data);
}
}
///-------------------
...
public function full_co_op_wp($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/co_op_wp/full_view_co_op_wp',$data);
}
