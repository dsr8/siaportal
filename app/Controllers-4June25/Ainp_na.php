...
class Ainp_na extends BaseController
{


public function edit_ainp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/ainp_na/edit_ainp_na',$data);
}
}
///-------------------

///////new start///////
public function edit_ainp_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/ainp_na/edit_ainp_na_new',$data);
}
}
///-------------------
...
public function full_ainp_na($category,$id,$sid){
