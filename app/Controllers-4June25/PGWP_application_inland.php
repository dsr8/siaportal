...
class PGWP_application_inland extends BaseController
{


public function edit_PGWP_application_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/PGWP_application_inland/edit_PGWP_application_inland',$data);
}
}
///-------------------
...
public function edit_PGWP_application_inland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/PGWP_application_inland/edit_PGWP_application_inland_new',$data);
}
}
///-------------------
...
public function full_PGWP_application_inland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/PGWP_application_inland/full_view_PGWP_application_inland',$data);
}
