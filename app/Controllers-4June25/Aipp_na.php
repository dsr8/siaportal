...
class Aipp_na extends BaseController
{


public function edit_aipp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/aipp_na/edit_aipp_na',$data);
}
}
///-------------------
////////////////new start/////////

public function edit_aipp_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/aipp_na/edit_aipp_na_new',$data);
}
}
///-------------------

/////////////// new end //////////
public function full_aipp_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/aipp_na/full_view_aipp_na',$data);
}
