...
class Restoration_Of_Status_students extends BaseController
{
...
////////////new start
public function edit_students_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/restoration_of_status_students/edit_students_new',$data);
}
}
...
public function full_student_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/restoration_of_status_students/full_students_new',$data);
