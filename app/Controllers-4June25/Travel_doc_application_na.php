...
class Travel_doc_application_na extends BaseController
{


public function edit_travel_doc_application_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/travel_doc_application_na/edit_travel_doc_application_na',$data);
}
}
///-------------------
...
public function edit_travel_doc_application_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/travel_doc_application_na/edit_travel_doc_application_na_new',$data);
}
}
///-------------------
/////////////////new end

public function full_travel_doc_application_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/travel_doc_application_na/full_view_travel_doc_application_na',$data);
}
