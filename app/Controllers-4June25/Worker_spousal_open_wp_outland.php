...
class Worker_spousal_open_wp_outland extends BaseController
{


public function edit_worker_spousal_open_wp_outland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/worker_spousal_open_wp_outland/edit_worker_spousal_open_wp_outland',$data);
}
}
...
////////////new start
public function edit_worker_spousal_open_wp_outland_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/worker_spousal_open_wp_outland/edit_worker_spousal_open_wp_outland_new',$data);
}
}
...
public function full_worker_spousal_open_wp_outland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/worker_spousal_open_wp_outland/full_view_worker_spousal_open_wp_outland',$data);
