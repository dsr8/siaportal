...
class Citizenship_certi_application_adult extends BaseController
{


public function edit_citizenship_certi_application_adult($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Citizenship_certi_application_adult/edit_citizenship_certi_application_adult',$data);
}
}
///-------------------
...
public function edit_citizenship_certi_application_adult_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/Citizenship_certi_application_adult/edit_citizenship_certi_application_adult_new',$data);
}
}
///-------------------
...
public function full_citizenship_certi_application_adult($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/Citizenship_certi_application_adult/full_view_citizenship_certi_application_adult',$data);
}
