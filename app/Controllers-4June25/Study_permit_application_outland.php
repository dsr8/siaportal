...
class Study_permit_application_outland extends BaseController
{


public function edit_study_permit_application_outland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/study_permit_application_outland/edit_study_permit_application_outland',$data);
}
}
///-------------------
...
public function full_study_permit_application_outland($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/study_permit_application_outland/full_view_study_permit_application_outland',$data);
}
