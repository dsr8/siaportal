...
class International_exp_class_na extends BaseController
{


public function edit_international_exp_class_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/international_exp_class_na/edit_international_exp_class_na',$data);
}
}
///-------------------
////////////new start
public function edit_international_exp_class_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/international_exp_class_na/edit_international_exp_class_na_new',$data);
}
}
///-------------------
...
public function full_international_exp_class_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/international_exp_class_na/full_view_international_exp_class_na',$data);
}
