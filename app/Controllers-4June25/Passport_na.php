...
class Passport_na extends BaseController
{


public function edit_passport_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/passport_na/edit_passport_na',$data);
}
}
///-------------------

////////////new start
public function edit_passport_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/passport_na/edit_passport_na_new',$data);
}
}
///-------------------
...
public function full_passport_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/passport_na/full_view_passport_na',$data);
}
