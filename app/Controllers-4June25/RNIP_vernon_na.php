...
class RNIP_vernon_na extends BaseController
{


public function edit_rnip_vernon_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/rnip_vernon_na/edit_rnip_vernon_na',$data);
}
}
///-------------------
public function edit_rnip_vernon_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/rnip_vernon_na/edit_rnip_vernon_na_new',$data);
}
}
///-------------------
...
public function full_rnip_vernon_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/rnip_vernon_na/full_view_rnip_vernon_na',$data);
}
