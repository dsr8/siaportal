...
class Family_sponsorship_na extends BaseController
{


public function edit_family_sponsorship_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/family_sponsorship_na/edit_family_sponsorship_na',$data);
}
}
///-------------------
...
public function edit_family_sponsorship_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/family_sponsorship_na/edit_family_sponsorship_na_new',$data);
}
}
///-------------------
///////////new end
public function full_family_sponsorship_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/family_sponsorship_na/full_view_family_sponsorship_na',$data);
}
