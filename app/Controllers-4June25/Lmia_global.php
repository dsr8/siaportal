...
class Lmia_global extends BaseController
{


public function edit_lmia_global_tlnt_high_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_global/edit_lmia_global_tlnt_high_wage',$data);
}
}
///-------------------

///////////new start
public function edit_lmia_global_tlnt_high_wage_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_global/edit_lmia_global_tlnt_high_wage_new',$data);
}
}
///-------------------
///////////new end

public function full_lmia_global_tlnt_high_wage($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/lmia_global/full_view_lmia_global_tlnt_high_wage',$data);
}
