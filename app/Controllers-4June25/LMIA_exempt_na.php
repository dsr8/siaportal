...
class LMIA_exempt_na extends BaseController
{


public function edit_LMIA_exempt_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/LMIA_exempt_na/edit_LMIA_exempt_na',$data);
}
}
///-------------------
...
public function edit_LMIA_exempt_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/LMIA_exempt_na/edit_LMIA_exempt_na_new',$data);
}
}
///-------------------
...
public function full_LMIA_exempt_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/LMIA_exempt_na/full_view_LMIA_exempt_na',$data);
}
