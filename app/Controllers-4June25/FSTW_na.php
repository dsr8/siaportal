...
class FSTW_na extends BaseController
{


public function edit_fstw_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/fstw_na/edit_fstw_na',$data);
}
}
///-------------------
//////////new start

public function edit_fstw_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/fstw_na/edit_fstw_na_new',$data);
}
}
///-------------------

//////////new end
public function full_fstw_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/fstw_na/full_view_fstw_na',$data);
}
