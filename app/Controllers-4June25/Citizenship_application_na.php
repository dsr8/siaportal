...
class Citizenship_application_na extends BaseController
{


public function edit_citizenship_application_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/citizenship_application_na/edit_citizenship_application_na',$data);
}
}
///-------------------
...
public function edit_citizenship_application_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/citizenship_application_na/edit_citizenship_application_na_new',$data);
}
}
///-------------------

///////////new end
public function full_citizenship_application_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/citizenship_application_na/full_view_citizenship_application_na',$data);
}
