...
class CAIPS_NOTES_GCMS extends BaseController
{


public function edit_caips_notes_gcms($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/caips_notes_gcms/edit_caips_notes_gcms',$data);
}
}
///-------------------


public function edit_caips_notes_gcms_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/caips_notes_gcms/edit_caips_notes_gcms_new',$data);
}
}
///-------------------
...
public function full_caips_notes_gcms($category,$id,$sid){
