...
class RNIP_sault_na extends BaseController
{


public function edit_rnip_sault_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/rnip_sault_na/edit_rnip_sault_na',$data);
}
}
///-------------------

//////////////new start
public function edit_rnip_sault_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/rnip_sault_na/edit_rnip_sault_na_new',$data);
}
}
///-------------------
//////////////new end

public function full_rnip_sault_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/rnip_sault_na/full_view_rnip_sault_na',$data);
}
