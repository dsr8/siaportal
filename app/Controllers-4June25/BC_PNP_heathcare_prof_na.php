...
class BC_PNP_heathcare_prof_na extends BaseController
{


public function edit_bc_pnp_heathcare_prof_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bc_pnp_heathcare_prof_na/edit_bc_pnp_heathcare_prof_na',$data);
}
}
///-------------------
...
////////////new start/////////
public function edit_bc_pnp_heathcare_prof_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/bc_pnp_heathcare_prof_na/edit_bc_pnp_heathcare_prof_na_new',$data);
}
}
///-------------------
////////////new end //////////

public function full_bc_pnp_heathcare_prof_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_heathcare_prof_na/full_view_bc_pnp_heathcare_prof_na',$data);
}
