...
class BC_PNP_Semi_Skilled_na extends BaseController
{


public function edit_BC_PNP_Semi_Skilled_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/bc_pnp_semi_skilled_na/edit_bc_pnp_semi_skilled_na',$data);
}
}
///-------------------

////////////new start
public function edit_BC_PNP_Semi_Skilled_na_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/bc_pnp_semi_skilled_na/edit_bc_pnp_semi_skilled_na_new',$data);
}
}
///-------------------
////////////new end

public function full_bc_pnp_semi_skilled_na($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_semi_skilled_na/full_view_bc_pnp_semi_skilled_na',$data);
}
