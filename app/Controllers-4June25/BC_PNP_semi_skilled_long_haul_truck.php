...
class BC_PNP_semi_skilled_long_haul_truck extends BaseController
{


public function edit_bc_pnp_semi_skilled_long_haul_truck($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/bc_pnp_semi_skilled_long_haul_truck/edit_bc_pnp_semi_skilled_long_haul_truck',$data);
}
}
///-------------------
...
public function edit_bc_pnp_semi_skilled_long_haul_truck_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
  ...
  $acc = new Account_model(); 
		...
		return view('admin/bc_pnp_semi_skilled_long_haul_truck/edit_bc_pnp_semi_skilled_long_haul_truck_new',$data);
}
}
///-------------------
/////////////new end /////////

public function full_bc_pnp_semi_skilled_long_haul_truck($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/bc_pnp_semi_skilled_long_haul_truck/full_view_bc_pnp_semi_skilled_long_haul_truck',$data);
}
