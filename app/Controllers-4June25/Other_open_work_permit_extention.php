...
class Other_open_work_permit_extention extends BaseController
{


public function edit_other_open_work_permit_extention($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/other_open_work_permit_extention/edit_other_open_work_permit_extention',$data);
}
}
///-------------------

//////////new start
public function edit_other_open_work_permit_extention_new($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
		...
		return view('admin/other_open_work_permit_extention/edit_other_open_work_permit_extention_new',$data);
}
}
///-------------------
...
public function full_other_open_work_permit_extention($category,$id,$sid){
...
$data['cpml'] = $cpm->where('id',$id)
    ...
    return view('admin/other_open_work_permit_extention/full_view_other_open_work_permit_extention',$data);
}
