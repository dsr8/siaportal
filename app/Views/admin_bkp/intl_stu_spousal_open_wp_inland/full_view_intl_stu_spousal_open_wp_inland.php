...
<input type="hidden"  name="news_image1_old" value="<?php echo $cpm['0']['voice_msg'];?>">
    ...
    <input type="text"value="<?php echo $cpm['0']['st'];?>"  class="form-control aa" readonly id="application_status"  name="application_status"  >
                  ...
                  <!--/Table Style-->
                        ...
                        <div class="row">
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="36" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter study permit expiry date" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="313" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea  class="form-control aa" readonly  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Note's" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
</div>
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="37" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control aa" readonly placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="38"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control aa" readonlyreadonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="39" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea class="form-control aa" readonly name="bio_com_note"  id="bio_com_note" ><?php echo $cpm['0']['bio_com_note'];?>"</textarea>
  ...
  <!--section End -->
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="40" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="41" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="42" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="date_for_medical_ten" id="date_for_medical_ten" placeholder="Enter date for medical tentative" class="form-control aa" readonly   readonly="" value="<?php echo $cpm['0']['date_for_medical_ten'];?>"  />
</div> 
 ...
 <textarea name="medical_note" id="medical_note" placeholder="Enter note's" class="form-control aa" readonly ><?php echo $cpm['0']['medical_note'];?></textarea>
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="43" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control aa" readonly  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="44" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
