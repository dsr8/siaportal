            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Full View Spausal Sponsorship Outland</h1>
...
<input type="hidden"  name="news_image1_old" value="<?php echo $cpm['0']['voice_msg'];?>">
 ...
 <input  class="form-control aa" readonly   placeholder="Enter date of application received" value="<?php echo $cpm['0']['assign_to'];?>"  readonly="readonly"  />
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="23" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter study permit expiry date" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="327" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control aa" readonly  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter document requested date" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
</div>
...
<!--section Start -->
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="24" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <textarea name="client_card_note" id="client_card_note"  placeholder="Enter reason" class="form-control aa" readonly>?php echo $cpm['0']['client_card_note'];?></textarea>  
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " id="25"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<label class="small mb-1" for="inputFirstName">Date Of Biometric received</label><!--date line-->
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control aa" readonlyreadonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="26" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="27" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="28" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea name="medical_sub_note" id="medical_sub_note" class="form-control aa" readonly  placeholder="Enter note's"  ><?php echo $cpm['0']['medical_sub_note'];?></textarea>
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="29" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >ADR IRCC</h2>
                <div class="table-tabs">
 ...
 <input  class="form-control aa" readonly name="adr_submission_date"  id="adr_submission_date" class="form-control aa" readonly  placeholder="Enter submission date" readonly="" value="<?php echo $cpm['0']['adr_submission_date'];?>"   />
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="30" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="31" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="32" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="pp_tentative" id="pp_tentative" value="<?php echo $cpm['0']['pp_tentative'];?>" class="form-control aa" readonly placeholder="Enter PP submition tentative"   readonly=""  />
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="34" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control aa" readonly  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
</div>  
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="33" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
