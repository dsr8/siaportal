...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Lmia work permit High Wage</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Lmia_wp_hg/edit_lmia_wp_high_wage/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="460">Assign Team Member</option> 
          <?php } elseif($app_st=='460'){ ?> 
        <option value="461">Application In Process</option>
         <?php } elseif($app_st=='461'){ ?> 
        <option value="462">Information Requested For Advertisement</option>
         <?php } elseif($app_st=='462'){ ?> 
        <option value="463">Advertisement Started</option>   
         <?php } elseif($app_st=='463'){ ?>          
        <option value="464">Documents Awaiting For Submission</option>  
         <?php } elseif($app_st=='464'){ ?> 
        <option value="465">Advertisement Renewal 1st Stage</option>    
         <?php } elseif($app_st=='465'){ ?>       
        <option value="466">Application Submitted</option> 
         <?php } elseif($app_st=='466'){ ?>            
        <option value="467">LMIA Number Received</option>  
         <?php } elseif($app_st=='467'){ ?>           
        <option value="468">Interview/ADR Requested</option>   
         <?php } elseif($app_st=='468'){ ?>          
        <option value="469">Interview/ADR Completed</option>  
         <?php } elseif($app_st=='469'){ ?>           
        <option value="470">Advertisement Renewal 2nd Stage</option> 
         <?php } elseif($app_st=='470'){ ?> 
         <option value="471">Approved</option> 
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="460" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="461" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section End -->
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="462" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea  class="form-control"  name="doc_await_note" id="doc_await_note"  type="text" placeholder="Enter Advertisement Fees Paid Invoice Number" ><?php echo $cpm['0']['doc_await_note'];?></textarea>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="463" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="ad_oa_end_date" id="ad_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['ad_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="464" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="465" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="st_oa_end_date" id="st_oa_end_date"  type="text" placeholder="Enter End Date" value="<?php echo $cpm['0']['st_oa_end_date'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="466" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="467"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="lmia_number" id="lmia_number" placeholder="Enter LMIA Number" class="form-control"readonly="" value="<?php echo $cpm['0']['lmia_number'];?>">
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="468" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="469" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="471" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
if(app_status=='460'){  
$( "#460" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='461'){
$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='462'){

$( "#460" ).removeClass( "show" ).addClass( "hide" );

$( "#461" ).removeClass( "show" ).addClass( "hide" );

$( "#462" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='463'){

$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='464'){

$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
$( "#464" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='465'){

$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
$( "#464" ).removeClass( "show" ).addClass( "hide" );
$( "#465" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='466'){
$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
$( "#464" ).removeClass( "show" ).addClass( "hide" );
$( "#465" ).removeClass( "show" ).addClass( "hide" );
$( "#466" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='467'){
$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
$( "#464" ).removeClass( "show" ).addClass( "hide" );
$( "#465" ).removeClass( "show" ).addClass( "hide" );  
$( "#466" ).removeClass( "show" ).addClass( "hide" );
$( "#467" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='468'){
  $( "#460" ).removeClass( "show" ).addClass( "hide" );
  $( "#461" ).removeClass( "show" ).addClass( "hide" );
  $( "#462" ).removeClass( "show" ).addClass( "hide" );
  $( "#463" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#465" ).removeClass( "show" ).addClass( "hide" );
  $( "#466" ).removeClass( "show" ).addClass( "hide" );
  $( "#467" ).removeClass( "show" ).addClass( "hide" );
  $( "#468" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='469'){
$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
...
$( "#466" ).removeClass( "show" ).addClass( "hide" );
$( "#467" ).removeClass( "show" ).addClass( "hide" );
$( "#468" ).removeClass( "show" ).addClass( "hide" );
$( "#469" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='470'){
$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
...
$( "#467" ).removeClass( "show" ).addClass( "hide" );
$( "#468" ).removeClass( "show" ).addClass( "hide" );
$( "#469" ).removeClass( "show" ).addClass( "hide" );
$( "#470" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='471'){
$( "#460" ).removeClass( "show" ).addClass( "hide" );
$( "#461" ).removeClass( "show" ).addClass( "hide" );
$( "#462" ).removeClass( "show" ).addClass( "hide" );
$( "#463" ).removeClass( "show" ).addClass( "hide" );
...
$( "#468" ).removeClass( "show" ).addClass( "hide" );
$( "#469" ).removeClass( "show" ).addClass( "hide" );
$( "#470" ).removeClass( "show" ).addClass( "hide" );
$( "#471" ).removeClass( "hide" ).addClass( "show" );
}
