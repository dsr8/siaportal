                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                             <?php foreach($adv as $nf){ ?>
                                            <tr>
                                                <td><?php echo $nf['id'];?></td>

                                                <td><?php echo $nf['ad_il_start_date'];?></td>
                                                <td><?php echo $nf['ad_il_end_date'];?></td>
                                               
                                                <td><?php echo $nf['ad_ki_start_date'];?></td>
                                                 <td><?php echo $nf['ad_ki_end_date'];?></td>

                                                   <td><?php echo $nf['ad_ca_start_date'];?></td>
                                                 <td><?php echo $nf['ad_ca_end_date'];?></td>

                                                   <td><?php echo $nf['ad_oa_start_date'];?></td>
                                                 <td><?php echo $nf['ad_oa_end_date'];?></td>
