...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Work Permit LMIA Inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Work_permit_LMIA_inland/edit_Work_permit_LMIA_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="549">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==549) { ?> 
       
        <option value="550">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==550) { ?> 
        <option value="551">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==551) { ?> 
         <option value="552">Approved</option> 
         <option value="553">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="549" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="550" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="551" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="553" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="552" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='549'){  
$( "#549" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='550'){
$( "#549" ).removeClass( "show" ).addClass( "hide" );
$( "#550" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='551'){

$( "#549" ).removeClass( "show" ).addClass( "hide" );

$( "#550" ).removeClass( "show" ).addClass( "hide" );

$( "#551" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='552'){

$( "#549" ).removeClass( "show" ).addClass( "hide" );
$( "#550" ).removeClass( "show" ).addClass( "hide" );
$( "#551" ).removeClass( "show" ).addClass( "hide" );
$( "#552" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='553'){

$( "#549" ).removeClass( "show" ).addClass( "hide" );
$( "#550" ).removeClass( "show" ).addClass( "hide" );
$( "#551" ).removeClass( "show" ).addClass( "hide" );
$( "#552" ).removeClass( "show" ).addClass( "hide" );
$( "#553" ).removeClass( "hide" ).addClass( "show" );
}
