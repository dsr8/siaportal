...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Conjugal Sponsorship</h1>
 ...
 <form id="myform1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Conjugal_sponsorship/edit_conjugal_sponsorship_new/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>">
