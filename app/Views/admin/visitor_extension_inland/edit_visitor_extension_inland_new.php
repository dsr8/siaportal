...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Visitor Extension Inland</h1>
 ...
 <form id="myform1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Visitor_extension_inland/edit_visitor_extension_inland_new/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
<div class="col-lg-6 col-md-6 col-sm-6 mb-6">
 ...
 <div class="col-lg-6 col-md-6 col-sm-6 mb-6">
    ...
    <option value="<?php echo $cpm['0']['application_status'];?>"><?php echo  $app_st=$cpm['0']['st'];?></option>
        ...
        <!--option value="35">Ready To Apply</option--> 
         <option value="575">Assign Team Member</option> 
        
       
       
        <option value="142">Application in Process</option>
       
        <option value="145">Application Submitted</option> 
        
         <option value="150">Approved</option> 
         <option value="151">Refused</option> 
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="575" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="142" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="145" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="151" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="150" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
$( "#575" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='142'){
$( "#575" ).removeClass( "show" ).addClass( "hide" );
$( "#142" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='145'){

$( "#575" ).removeClass( "show" ).addClass( "hide" );

$( "#142" ).removeClass( "show" ).addClass( "hide" );

$( "#145" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='150'){

$( "#575" ).removeClass( "show" ).addClass( "hide" );
$( "#142" ).removeClass( "show" ).addClass( "hide" );
$( "#145" ).removeClass( "show" ).addClass( "hide" );
$( "#150" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='151'){

$( "#575" ).removeClass( "show" ).addClass( "hide" );
$( "#142" ).removeClass( "show" ).addClass( "hide" );
$( "#145" ).removeClass( "show" ).addClass( "hide" );
$( "#150" ).removeClass( "show" ).addClass( "hide" );
$( "#151" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
