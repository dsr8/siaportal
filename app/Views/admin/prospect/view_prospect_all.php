            ...
            <div id="layoutSidenav_content">
               ...
               <th >Voice</th>
                ...
                <th >Admin Status</th>
                                        ...
                                        <tbody>
                                             <?php foreach($prospect_all as $allcat){ ?>
                                            <tr>
...
if($allcat['voice_added']=='siaportal'){
 ...
 <?php } else { ?>
                  ...
                  <td style="color:red"><?php echo $allcat['heading'];?>/</br><?php echo $allcat['email'];?>
...
<td><?php echo $allcat['heading'];?>/</br><?php echo $allcat['email'];?>
    <?php if (!empty($bookedIds[(int)$allcat['id']])):
        $appt = $bookedIds[(int)$allcat['id']];
        $sColors = [0=>'#856404',1=>'#0f5132',2=>'#084298',3=>'#842029'];
        $sLabels = [0=>'Pending',1=>'Confirmed',2=>'Completed',3=>'Cancelled'];
