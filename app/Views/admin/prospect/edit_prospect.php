...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                    ...
                                    <div class="form-card-body">
                                        ...
                                        <div class="field-group">
                                            ...
                                            <div class="field-icon-wrap">
                                                ...
                                                <input class="form-input" id="heading" type="text" name="heading" value="<?php echo htmlspecialchars($prospect['0']['heading']); ?>" placeholder="Enter full name" autocomplete="off" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field-group">
                                            ...
                                            <div class="field-icon-wrap">
                                                ...
                                                <input class="form-input" id="email" type="text" name="email" value="<?php echo htmlspecialchars($prospect['0']['email']); ?>" placeholder="Enter email address" autocomplete="off" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field-group">
                                            ...
                                            <div class="phone-row">
                                                ...
                                                <div class="num-wrap">
                                                    <input class="form-input num-input" id="number" type="text" name="number" value="<?php echo htmlspecialchars($prospect['0']['number']); ?>" placeholder="Phone number" autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display:flex;gap:12px;">
                                            <div class="field-group" style="flex:1;">
                                                ...
                                                <div class="field-icon-wrap">
                                                    ...
                                                    <input class="form-input" id="dob" type="date" name="dob" value="<?php echo htmlspecialchars($prospect['0']['user_dob']); ?>" />
                                                </div>
                                            </div>
                                            <div class="field-group" style="flex:1;">
                                                ...
                                                <div class="field-icon-wrap">
                                                    ...
                                                    <input class="form-input" id="spouse_name" type="text" name="spouse_name" value="<?php echo htmlspecialchars($prospect['0']['spouse_name']); ?>" placeholder="Spouse name" autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="field-group">
                                            ...
                                            <div class="field-icon-wrap">
                                                ...
                                                <input class="form-input" id="address" type="text" name="address" value="<?php echo htmlspecialchars($prospect['0']['address']); ?>" placeholder="Enter address" autocomplete="off" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field-group">
                                            ...
                                            <div class="field-icon-wrap">
                                                ...
                                                <input class="form-input" id="city" type="text" name="city" value="<?php echo htmlspecialchars($prospect['0']['city']); ?>" placeholder="Enter city" autocomplete="off" />
                                            </div>
                                        </div>
        ...
        $(document).ready(function () {
            ...
            $('#cc').val('<?php echo $prospect['0']['cc']; ?>').trigger('change');
