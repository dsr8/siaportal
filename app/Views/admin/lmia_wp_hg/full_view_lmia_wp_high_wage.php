...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control aa" readonly placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
                   ...
                   <div class="col-lg-3 col-md-3 col-sm-3 mb-3">
                    ...
                    <br>
                     <a target="_blank" href="<?php echo base_url();?>/assets/resume/<?php echo $cpm['0']['fee_receipt'];?>">View</a>
 ...
 <br>
                     <a target="_blank" href="<?php echo base_url();?>/assets/resume/<?php echo $cpm['0']['int_req_upload'];?>">View</a>
 ...
 <!--input type="file" name="int_sub_to_ircc" id="int_sub_to_ircc"      /-->
  ...
  <br>
                     <a target="_blank" href="<?php echo base_url();?>/assets/resume/<?php echo $cpm['0']['int_sub_to_ircc'];?>">View</a>
