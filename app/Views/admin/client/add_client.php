...
<div class="form-group">
 ...
 <div class="col-md-6">
  <label class="small mb-1" for="inputFirstName">Contact Number</label>
    <input class="form-control py-4" name="contact" id="contact" type="text" placeholder="Enter contact number" />
 </div>
  </div>
  </div>
...
<div class="row">
 ...
 <div class="col-md-6">
  ...
  <label class="small mb-1" for="inputFirstName">Alternet Contact Number</label>
  <input class="form-control py-4" name="alt_mobile_no" id="alt_mobile_no" type="text" placeholder="Enter Alternet Contact Number" />
</div>
</div>
</div>
<div class="form-group">
  <label class="small mb-1" for="inputFirstName">Email </label>
    <input class="form-control py-4"name="email" id="email"  type="text" placeholder="Enter email" onfocusout="check_mail()" />
...
<div class="form-group">
        <label class="small mb-1" for="inputFirstName">Any Family member </label><br>

<input  id="family" name="family" type="radio" value="yes" onclick="afm_yes()" />Yes
<input  id="family1" name="family" type="radio" value="no" onclick="afm_no()" />No




        <input class="form-control hide" id="master_sia_id" name="master_sia_id"type="text" placeholder="Enter Family Tree" /></div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"></script>
    ...
    <script>
  function afm_yes(){
var fe =document.getElementById("family").value;
//alert(fe);
    if(fe=='yes'){
$( "#master_sia_id" ).removeClass("hide").addClass("show" );

    }
  }
  function afm_no(){
var fe1 =document.getElementById("family1").value;
//alert(fe1);
    if(fe1=='no'){
$( "#master_sia_id" ).removeClass("show").addClass("hide" );
...
$.ajax({  
     ...
     url: 'https://canada.siaimmigration.com/Siaportal/check_mail/'+ee, 
      
     success: function(result)
     {
     // alert(result);
   //$("#getCodeModal11").modal("show");
     //   $("#getCode").html(msg).show();
   //alert("Appoinments Reject Successfully");
   //location.reload();
     //$('#subcat'+dr_id).html(result);
