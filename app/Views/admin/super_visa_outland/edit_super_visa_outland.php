...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Super visa outland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Super_visa_outland/edit_super_visa_outland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        <option value="500">Assign Team Member</option> 
          <?php } else if ($cpm['0']['application_status']==500) { ?> 
        <option value="47">Application in Process</option>
          <?php } else if ($cpm['0']['application_status']==47) { ?> 
           
        <option value="46">Documents Awaiting For Submission</option>  
          <?php } else if ($cpm['0']['application_status']==46) { ?> 
         
        <option value="48">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==48) { ?>            
        <option value="49">Biometric Requested</option>  
          <?php } else if ($cpm['0']['application_status']==49) { ?>           
        <option value="50">Biometric Completed</option>  
          <?php } else if ($cpm['0']['application_status']==50) { ?> 
         <option value="51">Interview/ADR Requested </option> 
           <?php } else if ($cpm['0']['application_status']==51) { ?>  
                   
        <option value="52">Interview/ADR Completed</option> 
          <?php } else if ($cpm['0']['application_status']==52) { ?>            
      
         <option value="55">Approved</option> 
          <option value="54">Refused</option> 
          <?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="500" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="47" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="46" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="doc_req_on_date" id="doc_req_on_date"  type="text" placeholder="Enter Documents Received On" value="<?php echo $cpm['0']['doc_req_on_date'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="48" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="49"style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="text" name="date_bio_sent" id="date_bio_sent" placeholder="Enter Date of Biometric sent to client" class="form-control"readonly="" value="<?php echo $cpm['0']['date_bio_sent'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="50" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <textarea class="form-control" name="bio_com_note"  id="bio_com_note" ><?php echo $cpm['0']['bio_com_note'];?>"</textarea>
  ...
  <!--section End -->
    ...
    <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="51" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_req_upload_old" id="int_req_upload_old" value="<?php echo $cpm['0']['int_req_upload'];?>">
  ...
  <!--section End -->
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="52" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input type="hidden" name="int_sub_to_ircc_old" id="int_sub_to_ircc_old" value="<?php echo $cpm['0']['int_sub_to_ircc']?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="54" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="file" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="55" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='500'){  
$( "#500" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='47'){
$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='46'){

$( "#500" ).removeClass( "show" ).addClass( "hide" );

$( "#47" ).removeClass( "show" ).addClass( "hide" );

$( "#46" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='48'){

$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "show" ).addClass( "hide" );
$( "#46" ).removeClass( "show" ).addClass( "hide" );
$( "#48" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='49'){

$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "show" ).addClass( "hide" );
$( "#46" ).removeClass( "show" ).addClass( "hide" );
$( "#48" ).removeClass( "show" ).addClass( "hide" );
$( "#49" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='50'){

$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "show" ).addClass( "hide" );
$( "#46" ).removeClass( "show" ).addClass( "hide" );
$( "#48" ).removeClass( "show" ).addClass( "hide" );
$( "#49" ).removeClass( "show" ).addClass( "hide" );
$( "#50" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='51'){
$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "show" ).addClass( "hide" );
$( "#46" ).removeClass( "show" ).addClass( "hide" );
$( "#48" ).removeClass( "show" ).addClass( "hide" );
$( "#49" ).removeClass( "show" ).addClass( "hide" );
$( "#50" ).removeClass( "show" ).addClass( "hide" );
$( "#51" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='52'){
$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "show" ).addClass( "hide" );
$( "#46" ).removeClass( "show" ).addClass( "hide" );
$( "#48" ).removeClass( "show" ).addClass( "hide" );
$( "#49" ).removeClass( "show" ).addClass( "hide" );
$( "#50" ).removeClass( "show" ).addClass( "hide" );  
$( "#51" ).removeClass( "show" ).addClass( "hide" );
$( "#52" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='54'){
  $( "#500" ).removeClass( "show" ).addClass( "hide" );
  $( "#47" ).removeClass( "show" ).addClass( "hide" );
  $( "#46" ).removeClass( "show" ).addClass( "hide" );
  $( "#48" ).removeClass( "show" ).addClass( "hide" );
  ...
  $( "#50" ).removeClass( "show" ).addClass( "hide" );
  $( "#51" ).removeClass( "show" ).addClass( "hide" );
  $( "#52" ).removeClass( "show" ).addClass( "hide" );
  $( "#54" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='55'){
$( "#500" ).removeClass( "show" ).addClass( "hide" );
$( "#47" ).removeClass( "show" ).addClass( "hide" );
$( "#46" ).removeClass( "show" ).addClass( "hide" );
$( "#48" ).removeClass( "show" ).addClass( "hide" );
...
$( "#51" ).removeClass( "show" ).addClass( "hide" );
$( "#52" ).removeClass( "show" ).addClass( "hide" );
$( "#54" ).removeClass( "show" ).addClass( "hide" );
$( "#55" ).removeClass( "hide" ).addClass( "show" );
}
