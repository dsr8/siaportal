            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Restoration Of Status worker</h1>
...
<!--RNIP_west_kootenay_na/edit_rnip_west_kootenay_na-->
 <form id="myform1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Restoration_Of_Status_worker/edit_worker_new/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
