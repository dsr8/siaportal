            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View New Admission Records And Walkin Data</h1>
				...
				<th style="width:5px;">Sia Id /</br>Add on Date</th>
				<th style="width:5px;">Agent Name/Team Mamber Name</th>
...
<a href="https://wa.me/<?php echo $allcat['ccode'];?><?php echo $allcat['number'];?>" target="_blank" >
 <img class="whatsapp_icon"  src="https://siaimmigration.com/assets/images/whatsapp/whatsapp.png" alt="">
				  ...
				  <td style="width:5px;"><?php echo $allcat['short_news'];?>/<?php echo $allcat['insert_on'];?></hr></td>
				  
				  <td style="width:5px;"> <?php echo $allcat['agent_name'];?><br>
				  <?php echo $allcat['team_member'];?></td>
				  <td style="width:5px;"> <?php echo $allcat['typee'];?></td>
				  
				  <td style="width:5px;"><?php echo $allcat['number'];?> </td>
				   
				  <td style="width:5px;"> <?php echo $allcat['agent_status'];?>
				  ...
				  <td style="width:5px;"><?php echo $allcat['admin_status'];?>
