...
<?= view('admininclude/admin_nav'); ?>
 ...
 <form id="myform1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/International_exp_class_na/edit_international_exp_class_na_new/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
                  ...
                  <section class="section-preview">
                    ...
                    if($doc !=""){ 
                      ...
                      echo' <label class="small mb-1" for="inputFirstName">Document</label>';
                        ...
                        ?>
 <div class="form-group">
                        <a  data-toggle="tooltip" title="<?php echo $do['doc_name'];?>" target="_blank" href="<?php echo $do['client_document_link'];?>">   
