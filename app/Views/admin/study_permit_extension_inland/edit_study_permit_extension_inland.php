...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Study permit Extension inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Study_permit_extension_inland/edit_study_permit_extension_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="538">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==538) { ?> 
       
        <option value="87">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==87) { ?> 
        <option value="91">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==91) { ?> 
         <option value="97">Approved</option> 
         <option value="98">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="538" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="87" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="91" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="98" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="97" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='538'){  
$( "#538" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='87'){
$( "#538" ).removeClass( "show" ).addClass( "hide" );
$( "#87" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='91'){

$( "#538" ).removeClass( "show" ).addClass( "hide" );

$( "#87" ).removeClass( "show" ).addClass( "hide" );

$( "#91" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='97'){

$( "#538" ).removeClass( "show" ).addClass( "hide" );
$( "#87" ).removeClass( "show" ).addClass( "hide" );
$( "#91" ).removeClass( "show" ).addClass( "hide" );
$( "#98" ).removeClass( "show" ).addClass( "hide" );
$( "#97" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='98'){

$( "#538" ).removeClass( "show" ).addClass( "hide" );
$( "#87" ).removeClass( "show" ).addClass( "hide" );
$( "#91" ).removeClass( "show" ).addClass( "hide" );
$( "#97" ).removeClass( "show" ).addClass( "hide" );
$( "#98" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
