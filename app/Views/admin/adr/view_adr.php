                                    ...
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $nf['sia_id'];?></td>
                                                <td><?php echo htmlspecialchars($nf['team_member_name'] ?? '');?></td>
                                                <td><?php echo $nf['client_name'];?></td>
                                               
                                                <td><?php echo $nf['notes'];?></td>
                                                 <td><?php echo $nf['adr_start_date'];?></td>

                                                   <td><?php echo $nf['adr_end_date'];?></td>
                                                 <td><?php echo $nf['app_number'];?></td>
                                                  <td>

<?php if($nf['link']==''){echo "----";}else{ ?>
                                                    <a target="_blank" href="<?php echo $nf['link'];?>">View Document</a>

                                                <?php } ?>

                                                    </td>

                                                  <td><?php if($nf['status']=='0'){ echo "Not complete"; }else{ echo "Complete";}?></td>

                                     <td><a style="color:red;" href="<?php echo base_url();?>/Siaportal/edit_adr/<?php echo $nf['id'];?>">Edit</a></br>

                                        <a style="color:green;" href="<?php echo base_url();?>/Siaportal/del_adr/<?php echo $nf['id'];?>"> Mark completed</a>
