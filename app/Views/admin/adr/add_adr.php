...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Sia id</label>
    <input class="form-control py-4" name="sia_id" id="sia_id" type="text" placeholder="Enter Sia Id" required /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Client Name</label>
    <input class="form-control py-4" name="client_name" id="client_name" type="text" placeholder="Enter Client Name" required/></div>

    <div class="form-group"><label class="small mb-1" for="inputFirstName">Notes</label>
    <textarea class="form-control py-4" name="notes" id="notes" placeholder="Enter Notes" required></textarea></div>

     <div class="form-group"><label class="small mb-1" for="inputFirstName">Start Date</label>
    <input class="form-control py-4" name="adr_start_date" id="adr_start_date" required type="date" placeholder="Enter Start Date" /></div>

    <div class="form-group"><label class="small mb-1" for="inputFirstName">End Date</label>
    <input class="form-control py-4" name="adr_end_date" id="adr_end_date" required type="date" placeholder="Enter End Date" /></div>

    <div class="form-group"><label class="small mb-1" for="inputFirstName">Application Number</label>
    <input class="form-control py-4" name="app_number" id="app_number" required type="text" placeholder="Enter Application Number" /></div>


    <div class="form-group"><label class="small mb-1" for="inputFirstName">Upload Document</label>
    <input class="form-control py-4" name="adr_doc" id="adr_doc" type="file"  /></div>
