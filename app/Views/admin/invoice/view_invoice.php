...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
              ...
              <td><textarea name="agent_status" id="agent_status<?php echo $nf['id'];?>" onkeyup="updatestatus(<?php echo $nf['id'];?>);"><?php echo $nf['agent_status'];?></textarea></td>
...
<script>
    function updatestatus(id){
         ...
         // var zone = $(this).val();
        var as=document.getElementById("agent_status"+id).value;
