...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Citizenship certi application adult</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Citizenship_certi_application_adult/edit_citizenship_certi_application_adult/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="498">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==498) { ?> 
       
        <option value="258">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==258) { ?> 
        <option value="261">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==261) { ?> 
         <option value="264">Approved</option> 
         <option value="265">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="498" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="258" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="261" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="265" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="264" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='498'){  
$( "#498" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='258'){
$( "#498" ).removeClass( "show" ).addClass( "hide" );
$( "#258" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='261'){

$( "#498" ).removeClass( "show" ).addClass( "hide" );

$( "#258" ).removeClass( "show" ).addClass( "hide" );

$( "#261" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='264'){

$( "#498" ).removeClass( "show" ).addClass( "hide" );
$( "#258" ).removeClass( "show" ).addClass( "hide" );
$( "#261" ).removeClass( "show" ).addClass( "hide" );
$( "#264" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='265'){

$( "#498" ).removeClass( "show" ).addClass( "hide" );
$( "#258" ).removeClass( "show" ).addClass( "hide" );
$( "#261" ).removeClass( "show" ).addClass( "hide" );
$( "#264" ).removeClass( "show" ).addClass( "hide" );
$( "#265" ).removeClass( "hide" ).addClass( "show" );
}
