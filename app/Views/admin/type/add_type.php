            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_type"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Type</label>
    <input class="form-control py-4" name="type" id="type" type="text" placeholder="Enter type" /></div>
