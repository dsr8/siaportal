...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit BC pnp Semi skilled NA</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/BC_PNP_Semi_Skilled_na/edit_BC_PNP_Semi_Skilled_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="581">Assign Team Member</option>
         <?php } elseif($app_st=='581'){ ?> 
        <option value="582">Application in Process</option>
         <?php } elseif($app_st=='582'){ ?>
        <option value="583">Application Submitted</option> 
         <?php } elseif($app_st=='583'){ ?>
         
         <option value="584">Approved</option> 
         <option value="585">Refused</option> 
...
<?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="581" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="582" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="583" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="585" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="584" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='581'){  
$( "#581" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='582'){
$( "#581" ).removeClass( "show" ).addClass( "hide" );
$( "#582" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='583'){

$( "#581" ).removeClass( "show" ).addClass( "hide" );

$( "#582" ).removeClass( "show" ).addClass( "hide" );

$( "#583" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='584'){

$( "#581" ).removeClass( "show" ).addClass( "hide" );
$( "#582" ).removeClass( "show" ).addClass( "hide" );
$( "#583" ).removeClass( "show" ).addClass( "hide" );
$( "#585" ).removeClass( "show" ).addClass( "hide" );
$( "#584" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='585'){

$( "#581" ).removeClass( "show" ).addClass( "hide" );
$( "#582" ).removeClass( "show" ).addClass( "hide" );
$( "#583" ).removeClass( "show" ).addClass( "hide" );
$( "#584" ).removeClass( "show" ).addClass( "hide" );
$( "#585" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
