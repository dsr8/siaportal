            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Add Student Need Job</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"></li>
                        </ol>

                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_student_need_job" enctype="multipart/form-data"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName"> Name</label>
    ...
    <input class="form-control py-4" name="tag_search" id="tag_search" type="text" placeholder="Enter Tag Search" /></div>
...
<div class="form-group" style="margin-top: 110px;"><label class="small mb-1" for="inputFirstName">Source</label><select class="form-control"NAME="source">
    ...
    <input class="form-control py-4" name="having_canada_visa" id="having_canada_visa" type="text" placeholder="Enter Having Canada Visa" /></div>
