...
if($app_st=='35'){ ?>
        ...
        <option value="375">Assign Team Member</option> 
         <?php } elseif($app_st=='375'){ ?> 
        <option value="376">Application in Process</option>
         <?php } elseif($app_st=='376'){ ?> 
        <option value="377">Application Submitted</option> 
         <?php } elseif($app_st=='377'){ ?> 
         
         <option value="378">Approved</option> 
         <option value="379">Refused</option> 
...
<?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="375" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="376" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="377" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="379" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="378" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='375'){  
$( "#375" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='376'){
$( "#375" ).removeClass( "show" ).addClass( "hide" );
$( "#376" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='377'){

$( "#375" ).removeClass( "show" ).addClass( "hide" );

$( "#376" ).removeClass( "show" ).addClass( "hide" );

$( "#377" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='378'){

$( "#375" ).removeClass( "show" ).addClass( "hide" );
$( "#376" ).removeClass( "show" ).addClass( "hide" );
$( "#377" ).removeClass( "show" ).addClass( "hide" );
$( "#378" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='379'){

$( "#375" ).removeClass( "show" ).addClass( "hide" );
$( "#376" ).removeClass( "show" ).addClass( "hide" );
$( "#377" ).removeClass( "show" ).addClass( "hide" );
$( "#378" ).removeClass( "show" ).addClass( "hide" );
$( "#379" ).removeClass( "hide" ).addClass( "show" );
}
