...
<?= view('admininclude/admin_nav'); ?>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/SINP_na/edit_sinp_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="430">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==430) { ?> 
       
        <option value="431">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==431) { ?> 
        <option value="432">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==432) { ?> 
         <option value="433">Approved</option> 
         <option value="434">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="430" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="431" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="432" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="434" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="433" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='430'){  
$( "#430" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='431'){
$( "#430" ).removeClass( "show" ).addClass( "hide" );
$( "#431" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='432'){

$( "#430" ).removeClass( "show" ).addClass( "hide" );

$( "#431" ).removeClass( "show" ).addClass( "hide" );

$( "#432" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='433'){

$( "#430" ).removeClass( "show" ).addClass( "hide" );
$( "#431" ).removeClass( "show" ).addClass( "hide" );
$( "#432" ).removeClass( "show" ).addClass( "hide" );
$( "#433" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='434'){

$( "#430" ).removeClass( "show" ).addClass( "hide" );
$( "#431" ).removeClass( "show" ).addClass( "hide" );
$( "#432" ).removeClass( "show" ).addClass( "hide" );
$( "#433" ).removeClass( "show" ).addClass( "hide" );
$( "#434" ).removeClass( "hide" ).addClass( "show" );
}
