            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">View Lmia Job</h1>
                    ...
                    <?php foreach ($lmia_job as $lj ) { ?>
   

                                            <tr>
                                                 <td><?php echo $lj['id']; ?></td>
                                                <td><?php echo $lj['emp_name']; ?></td>
                                                <td><?php echo $lj['req']; ?></td>
                                                <td><?php echo $lj['job_dec']; ?></td>
                                                <td> <?php echo $lj['type']; ?></td>
                                                <td><?php echo $lj['insert_on']; ?></td>
                                               <td><a href="<?php echo base_url();?>/Siaportal/edit_job_lmia/<?php echo $lj['id'];?>">Edit</a></td>
