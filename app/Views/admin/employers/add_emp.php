            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_emp"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Province Name</label><input class="form-control py-4" id="country" type="text" name="country" placeholder="Enter Province Name" required="required" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Company name</label><input class="form-control py-4" id="company_name" type="text" name="company_name" placeholder="Enter company name" /></div>



<div class="form-group"><label class="small mb-1" for="inputFirstName">Company Type</label><input class="form-control py-4" id="company_type" name="company_type" type="text" placeholder="Enter company type" /></div>
