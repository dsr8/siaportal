            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Add Lmia Job</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"></li>
                        </ol>

                       <form  id="myform" method="post" action="<?php echo base_url();?>/Siaportal/add_job_lmia"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Requriment</label>
    <input class="form-control py-4" name="req" id="req" type="text" placeholder="Enter Requriment" /></div>
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Job Descrption</label><input class="form-control py-4" id="job_dec" type="text" name="job_dec" placeholder="Enter Job Descrption" required="required" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Type</label><input class="form-control py-4" id="type" type="text" name="type" placeholder="Enter type" required="required" /></div>
