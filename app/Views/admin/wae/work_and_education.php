			  ...
			  <div class="left">
					  ...
					  <div class="epadd">
					      ...
					      <p style="color:black">WORK and Education (Please fill two separate sheets for spouse and main applicant)</p><br>
											...
											<form  method="post" class="form-horizontal" action="<?php echo base_url();?>Form/work_and_education" enctype='multipart/form-data'>
 ...
 <?php  
      ...
      <h2>TRAVEL HISTORY</h2>
                  ...
                  $th11 = explode(',', $th1);
                    ...
                    <input type="text" name="t_destination[]" id="t_destination" placeholder="Your answer" required value="<?php echo $th11[$i];?>" > 
