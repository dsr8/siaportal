            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit New Form</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"></li>
                        </ol>

                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/edit_new_form/<?php echo $new_form['0']['id'];?>"> 
                        <div class="row">
                          <div class="col-xl-3 col-md-3"></div>
                            <div class="col-xl-6 col-md-6">
                                
<div class="form-group"><label class="small mb-1" for="inputFirstName">Heading</label>
    <input class="form-control py-4" value="<?php echo $new_form['0']['heading'];?>" name="heading" id="heading" type="text" placeholder="Enter Heading" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Form Body</label>
    <input class="form-control py-4" name="form_body"value="<?php echo $new_form['0']['form_body'];?>" id="form_body" type="text" placeholder="Enter Contact Number" /></div>
