...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Visitor visa canada</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Visitor_visa_canada/edit_visitor_visa_canada/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
$( "#126" ).removeClass( "hide" ).addClass( "show" );
  ...
  $( "#128" ).removeClass( "show" ).addClass( "hide" );
