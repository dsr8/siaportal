                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                             <?php foreach($card as $cc){ ?>
                                            <tr>
                                                <td><?php echo $cc['siaportalid'];?></td>
                                                <td><?php echo $cc['mode_client_payment'];?></td>
                                                <td><?php echo $cc['confirm_with'];?></td>   
                                            <td><?php echo $cc['date_of_payment_recive'];?></td>
