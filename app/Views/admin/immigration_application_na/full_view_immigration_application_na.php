            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Full view Immigration Application Na</h1>
...
<div class="col-lg-6 col-md-6 col-sm-6 mb-6">
 ...
 <div class="col-lg-6 col-md-6 col-sm-6 mb-6">
    ...
    <input type="text"value="<?php echo $cpm['0']['st'];?>"  class="form-control aa" readonly id="application_status"  name="application_status"  ><br>
    <textarea name="if_any_note" class="form-control" placeholder="Enter if any note" readonly><?php echo $cpm['0']['if_any_note'];?></textarea>
