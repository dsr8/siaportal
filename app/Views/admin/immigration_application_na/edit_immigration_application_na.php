...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Immigration Application Na</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Immigration_application_na/edit_immigration_application_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="544">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==544) { ?> 
       
        <option value="545">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==545) { ?> 
        <option value="546">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==546) { ?> 
         <option value="547">Approved</option> 
         <option value="548">Refused</option> 
...
<textarea name="if_any_note" class="form-control" placeholder="Enter if any note"><?php echo $cpm['0']['if_any_note'];?></textarea>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="544" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="545" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="546" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="548" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="547" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='544'){  
$( "#544" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='545'){
$( "#544" ).removeClass( "show" ).addClass( "hide" );
$( "#545" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='546'){

$( "#544" ).removeClass( "show" ).addClass( "hide" );

$( "#545" ).removeClass( "show" ).addClass( "hide" );

$( "#546" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
else if(app_status=='547'){

$( "#544" ).removeClass( "show" ).addClass( "hide" );
$( "#545" ).removeClass( "show" ).addClass( "hide" );
$( "#546" ).removeClass( "show" ).addClass( "hide" );
$( "#548" ).removeClass( "show" ).addClass( "hide" );

$( "#547" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}

else if(app_status=='548'){

$( "#544" ).removeClass( "show" ).addClass( "hide" );
$( "#545" ).removeClass( "show" ).addClass( "hide" );
$( "#546" ).removeClass( "show" ).addClass( "hide" );
$( "#547" ).removeClass( "show" ).addClass( "hide" );
$( "#548" ).removeClass( "hide" ).addClass( "show" );
$("#note").prop('required',true);
 $("p").css("color", "red");
}
