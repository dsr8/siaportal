            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Worker spousal open wp outland</h1>
...
<!--RNIP_west_kootenay_na/edit_rnip_west_kootenay_na-->
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Worker_spousal_open_wp_outland/edit_worker_spousal_open_wp_outland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="425">Assign Team Member</option> 
         <?php } elseif($app_st=='425'){ ?>
        <option value="426">Application in Process</option>
         <?php } elseif($app_st=='426'){ ?>
        <option value="427">Application Submitted</option> 
         <?php } elseif($app_st=='427'){ ?>
         
         <option value="428">Approved</option> 
         <option value="429">Refused</option> 
         <?php } ?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="425" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="426" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="427" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="429" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="428" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='425'){  
$( "#425" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='426'){
$( "#425" ).removeClass( "show" ).addClass( "hide" );
$( "#426" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='427'){

$( "#425" ).removeClass( "show" ).addClass( "hide" );

$( "#426" ).removeClass( "show" ).addClass( "hide" );

$( "#427" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='428'){

$( "#425" ).removeClass( "show" ).addClass( "hide" );
$( "#426" ).removeClass( "show" ).addClass( "hide" );
$( "#427" ).removeClass( "show" ).addClass( "hide" );
$( "#429" ).removeClass( "show" ).addClass( "hide" );
$( "#428" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='429'){

$( "#425" ).removeClass( "show" ).addClass( "hide" );
$( "#426" ).removeClass( "show" ).addClass( "hide" );
$( "#427" ).removeClass( "show" ).addClass( "hide" );
$( "#428" ).removeClass( "show" ).addClass( "hide" );
$( "#429" ).removeClass( "hide" ).addClass( "show" );
}
