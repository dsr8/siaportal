...
<!--RNIP_west_kootenay_na/edit_rnip_west_kootenay_na-->
 <form id="myform1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Worker_spousal_open_wp_outland/edit_worker_spousal_open_wp_outland_new/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
