            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Send Whats App Message</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"></li>
                        </ol>

                       <form id="contactForm" method="post" action="<?php echo base_url();?>/Siaportal/send_whatsapp_msg" enctype="multipart/form-data" target="_blank"> 
                        <div class="row">
...
<div class="form-group">
    <label class="small mb-1" for="inputFirstName">Client Type </label>
...
<div class="form-group">
    <label class="small mb-1" for="inputFirstName">Start Id</label>
    
<input type="text" name="start_id" id="start_id" class="form-control">

</div>

<div class="form-group">
    <label class="small mb-1" for="inputFirstName">End Id</label>
    
<input type="text" name="end_id" id="end_id" class="form-control">

</div>

<div class="form-group">
    <label class="small mb-1" for="inputFirstName">Message</label>
