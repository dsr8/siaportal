...
<?= view('admininclude/admin_nav'); ?>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Aipp_na/edit_aipp_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="335">Assign Team Member</option> 
           <?php } elseif($app_st=='335'){ ?>
        <option value="336">Application in Process</option>
           <?php } elseif($app_st=='336'){ ?>
        <option value="337">Application Submitted</option> 
           <?php } elseif($app_st=='337'){ ?>
         
         <option value="338">Approved</option> 
         <option value="339">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="335" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="336" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="337" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="339" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="338" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='335'){  
$( "#335" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='336'){
$( "#335" ).removeClass( "show" ).addClass( "hide" );
$( "#336" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='337'){

$( "#335" ).removeClass( "show" ).addClass( "hide" );

$( "#336" ).removeClass( "show" ).addClass( "hide" );

$( "#337" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='338'){

$( "#335" ).removeClass( "show" ).addClass( "hide" );
$( "#336" ).removeClass( "show" ).addClass( "hide" );
$( "#337" ).removeClass( "show" ).addClass( "hide" );
$( "#338" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='339'){

$( "#335" ).removeClass( "show" ).addClass( "hide" );
$( "#336" ).removeClass( "show" ).addClass( "hide" );
$( "#337" ).removeClass( "show" ).addClass( "hide" );
$( "#338" ).removeClass( "show" ).addClass( "hide" );
$( "#339" ).removeClass( "hide" ).addClass( "show" );
}
