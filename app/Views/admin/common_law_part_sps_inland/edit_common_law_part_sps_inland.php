...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Common law part sps inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Common_law_part_sps_inland/edit_common_law_part_sps_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="501">Assign Team Member</option> 
           <?php } elseif($app_st=='501'){ ?>
        <option value="502">Application in Process</option>
           <?php } elseif($app_st=='502'){ ?>
        <option value="503">Application Submitted</option> 
           <?php } elseif($app_st=='503'){ ?>
         
         <option value="504">Approved</option> 
         <option value="505">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="501" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="502" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="503" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="505" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="504" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='501'){  
$( "#501" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='502'){
$( "#501" ).removeClass( "show" ).addClass( "hide" );
$( "#502" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='503'){

$( "#501" ).removeClass( "show" ).addClass( "hide" );

$( "#502" ).removeClass( "show" ).addClass( "hide" );

$( "#503" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='504'){

$( "#501" ).removeClass( "show" ).addClass( "hide" );
$( "#502" ).removeClass( "show" ).addClass( "hide" );
$( "#503" ).removeClass( "show" ).addClass( "hide" );
$( "#505" ).removeClass( "show" ).addClass( "hide" );
$( "#504" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='505'){

$( "#501" ).removeClass( "show" ).addClass( "hide" );
$( "#502" ).removeClass( "show" ).addClass( "hide" );
$( "#503" ).removeClass( "show" ).addClass( "hide" );
$( "#504" ).removeClass( "show" ).addClass( "hide" );
$( "#505" ).removeClass( "hide" ).addClass( "show" );
}
