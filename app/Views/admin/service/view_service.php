...
<?= view('admininclude/admin_nav'); ?>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                             <?php foreach($service as $nf){ ?>
                                            <tr>
                                                <td><?php echo $nf['id'];?></td>

                                                <td><?php echo $nf['heading'];?></td>
                                                <td><?php echo $nf['dataa'];?></td>
                                               
                                               
  <form action="<?php echo base_url();?>/Siaportal/edit_service_status/<?php  echo $nf['id'];?>" method="post">
				  <input type="hidden" name="id" value="<?php  echo $nf['id'];?>">
				  <td style="width:5px;">
				      <textarea name="status"> <?php echo $nf['status'];?></textarea>
  ...
  <td><a  class="on" target="_blank" href="<?php echo base_url();?>/Siaportal/edit_service/<?php echo $nf['id'];?>">Edit</a></td>
