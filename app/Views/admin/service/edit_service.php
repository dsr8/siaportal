            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       ...
                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/edit_service/<?php echo $service['0']['id'];?>" enctype="multipart/form-data"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName">Heading</label>
    <input class="form-control py-4" name="heading" id="heading" type="text" placeholder="Enter Heading" required value="<?php echo $service['0']['heading'];?>" /></div>
<div class="form-group"><label class="small mb-1" for="inputFirstName">Data</label>


   <textarea class="form-control py-4" name="dataa" id="dataa" ><?php echo $service['0']['dataa'];?></textarea>
