...
<html lang="en">
    <head>
        ...
        <title>Add Frontend Inquiries</title>
                        ...
                        <div class="form-wrapper">
                            <div class="form-card">
                                ...
                                <div class="form-card-header">
                                    <h2>Add Frontend Inquiry</h2>
                                    <p>Fill in the details below and click Submit Inquiry.</p>
                                </div>

                                <form id="contactForm" method="post" action="<?php echo base_url();?>/Siaportal/add_frontend_inquiries" enctype="multipart/form-data">
                                    <div class="form-card-body">
                                        ...
                                        <!-- Type -->
                                        <div class="field-group">
                                            <label for="typee">Type <span class="req">*</span></label>
                                            <div class="field-icon-wrap">
                                                <i class="fas fa-tag fi"></i>
                                                <select class="form-select" name="typee" id="typee" onchange="tag()">
                                                    <option value="Immigration">Canada</option>
                                        ...
                                        <!-- Having Canada Visa (conditional) -->
                                        <div class="field-group hide" id="tegg">
                                            <label for="having_canada_visa">Having Canada Visa <span class="req">*</span></label>
                                            <div class="field-icon-wrap">
                                                <i class="fas fa-passport fi"></i>
                                                <input class="form-input" type="text" name="having_canada_visa" id="having_canada_visa" placeholder="Enter visa details" autocomplete="off" />
                                            </div>
                                        </div>
