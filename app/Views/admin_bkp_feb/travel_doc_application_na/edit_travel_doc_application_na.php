            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Travel doc application na</h1>
...
//exit();
        ...
        <!--option value="35">Ready To Apply</option--> 
         <option value="435">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==435) { ?> 
       
        <option value="436">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==436) { ?> 
        <option value="437">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==437) { ?> 
         <option value="438">Approved</option> 
         <option value="439">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="435" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="436" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="437" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="439" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="438" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='435'){  
$( "#435" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='436'){
$( "#435" ).removeClass( "show" ).addClass( "hide" );
$( "#436" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='437'){

$( "#435" ).removeClass( "show" ).addClass( "hide" );

$( "#436" ).removeClass( "show" ).addClass( "hide" );

$( "#437" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='438'){

$( "#435" ).removeClass( "show" ).addClass( "hide" );
$( "#436" ).removeClass( "show" ).addClass( "hide" );
$( "#437" ).removeClass( "show" ).addClass( "hide" );
$( "#438" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='439'){

$( "#435" ).removeClass( "show" ).addClass( "hide" );
$( "#436" ).removeClass( "show" ).addClass( "hide" );
$( "#437" ).removeClass( "show" ).addClass( "hide" );
$( "#438" ).removeClass( "show" ).addClass( "hide" );
$( "#439" ).removeClass( "hide" ).addClass( "show" );
}
