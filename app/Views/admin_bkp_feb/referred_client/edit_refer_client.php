            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Reffer</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"></li>
                        </ol>

                       <form id="myform" method="post" action="<?php echo base_url();?>/Siaportal/edit_refer_client/<?php echo $refer['0']['id'];?>"> 
                        <div class="row">
...
<div class="form-group"><label class="small mb-1" for="inputFirstName"> Status</label>
    <input class="form-control py-4" name="refer_staus" id="refer_staus" value="<?php echo $refer['0']['refer_staus'];?>" type="text" placeholder="Enter Status" /></div>
