...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Common law part sps Outland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Common_law_part_sps_outland/edit_common_law_part_sps_outland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
if($app_st=='35'){ ?>
        ...
        <option value="506">Assign Team Member</option> 
           <?php } elseif($app_st=='506'){ ?>
        <option value="507">Application in Process</option>
           <?php } elseif($app_st=='507'){ ?>
        <option value="508">Application Submitted</option> 
           <?php } elseif($app_st=='508'){ ?>
         
         <option value="509">Approved</option> 
         <option value="510">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="506" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="507" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="508" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="510" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="509" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='506'){  
$( "#506" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='507'){
$( "#506" ).removeClass( "show" ).addClass( "hide" );
$( "#507" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='508'){

$( "#506" ).removeClass( "show" ).addClass( "hide" );

$( "#507" ).removeClass( "show" ).addClass( "hide" );

$( "#508" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='509'){

$( "#506" ).removeClass( "show" ).addClass( "hide" );
$( "#507" ).removeClass( "show" ).addClass( "hide" );
$( "#508" ).removeClass( "show" ).addClass( "hide" );
$( "#510" ).removeClass( "show" ).addClass( "hide" );
$( "#509" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='510'){

$( "#506" ).removeClass( "show" ).addClass( "hide" );
$( "#507" ).removeClass( "show" ).addClass( "hide" );
$( "#508" ).removeClass( "show" ).addClass( "hide" );
$( "#509" ).removeClass( "show" ).addClass( "hide" );
$( "#510" ).removeClass( "hide" ).addClass( "show" );
}
