...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit dli number change</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/DLI_NUMBER_CHANGE/edit_dli_number_change/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="487">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==487) { ?> 
       
        <option value="488">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==488) { ?> 
        <option value="489">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==489) { ?> 
         <option value="490">Approved</option> 
         <option value="491">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="487" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="488" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="489" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="491" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="490" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='487'){  
$( "#487" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='488'){
$( "#487" ).removeClass( "show" ).addClass( "hide" );
$( "#488" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='489'){

$( "#487" ).removeClass( "show" ).addClass( "hide" );

$( "#488" ).removeClass( "show" ).addClass( "hide" );

$( "#489" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='490'){

$( "#487" ).removeClass( "show" ).addClass( "hide" );
$( "#488" ).removeClass( "show" ).addClass( "hide" );
$( "#489" ).removeClass( "show" ).addClass( "hide" );
$( "#490" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='491'){

$( "#487" ).removeClass( "show" ).addClass( "hide" );
$( "#488" ).removeClass( "show" ).addClass( "hide" );
$( "#489" ).removeClass( "show" ).addClass( "hide" );
$( "#490" ).removeClass( "show" ).addClass( "hide" );
$( "#491" ).removeClass( "hide" ).addClass( "show" );
}
