...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit PGWP Application Inland</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/PGWP_application_inland/edit_PGWP_application_inland/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="496">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==496) { ?> 
       
        <option value="109">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==109) { ?> 
        <option value="112">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==112) { ?> 
         <option value="118">Approved</option> 
         <option value="117">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="496" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="109" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="112" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="117" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="118" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
if(app_status=='496'){  
$( "#496" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='109'){
$( "#496" ).removeClass( "show" ).addClass( "hide" );
$( "#109" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='112'){

$( "#496" ).removeClass( "show" ).addClass( "hide" );

$( "#109" ).removeClass( "show" ).addClass( "hide" );

$( "#112" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='117'){

$( "#496" ).removeClass( "show" ).addClass( "hide" );
$( "#109" ).removeClass( "show" ).addClass( "hide" );
$( "#112" ).removeClass( "show" ).addClass( "hide" );
$( "#117" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='118'){

$( "#496" ).removeClass( "show" ).addClass( "hide" );
$( "#109" ).removeClass( "show" ).addClass( "hide" );
$( "#112" ).removeClass( "show" ).addClass( "hide" );
$( "#117" ).removeClass( "show" ).addClass( "hide" );
$( "#118" ).removeClass( "hide" ).addClass( "show" );
}
