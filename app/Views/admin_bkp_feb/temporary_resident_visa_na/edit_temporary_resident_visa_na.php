...
<?= view('admininclude/admin_nav'); ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Temporary Resident Visa Na</h1>
 ...
 <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>/Temporary_resident_visa_na/edit_temporary_resident_visa_na/<?php echo $cpm['0']['category'];?>/<?php echo $cpm['0']['id'];?>/<?php echo $cpm['0']['type'];?>"> 
...
//exit();
        ...
        if($app_st==35){ ?>
        <!--option value="35">Ready To Apply</option--> 
         <option value="539">Assign Team Member</option> 
        
        <?php } else if ($cpm['0']['application_status']==539) { ?> 
       
        <option value="540">Application in Process</option>
       <?php } else if ($cpm['0']['application_status']==540) { ?> 
        <option value="541">Application Submitted</option> 
          <?php } else if ($cpm['0']['application_status']==541) { ?> 
         <option value="542">Approved</option> 
         <option value="543">Refused</option> 
...
<?php }?>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="539" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<?PHP $val = $tm['id'];?>
  ...
  <!--section End -->
                           ...
                           <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="540" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
 ...
 <input  class="form-control"  name="study_permit_exp" id="study_permit_exp"  type="text" placeholder="Enter advertisement cost invoice sent on" value="<?php echo $cpm['0']['study_permit_exp'];?>"   readonly="readonly"  />
  ...
  <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide " id="541" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
...
<div class="form-group">
 ...
 <label class="small mb-1" for="inputFirstName">Address Of Immigration Document Received</label> <input type="text" id="add_imm_doc_rec" name="add_imm_doc_rec" class="form-control" placeholder="Address Of Immigration Document Received"  value="<?php echo $cpm['0']['add_imm_doc_rec'];?>">
  ...
  <!--section End -->
   ...
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="543" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Refused</h2>
                <div class="table-tabs">
 ...
 <input  type="hidden" name="refusal_letter_old"  id="refusal_letter_old" class="form-control"  value="<?php echo $cpm['0']['refusal_letter'] ?>"    />
  ...
  <!--section End -->
   <!--section Start -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hide" id="542" style="margin-top:1px;">
            <div class="right-side">
              <div class="content" >
                <h2 >Approved</h2>
                <div class="table-tabs">
...
$(document).ready(function () {
    ...
    $('#myform').validate({ // initialize the plugin
        ...
        messages: {
          ...
          retainer_app: "Retainer application IS Required",
          govt_fee: "Payment plan application IS Required",
          pay_plan: "Estimated application IS Required",
          est_app: "Total Payment Plan IS Required",
          est_num: "Application Govt fee will be paid from IS Required",
          tolat_pay_plan: "Estimated Number IS Required",
          tolat_pay_amount: "Total Payment  IS Required",
...
if(app_status=='539'){  
$( "#539" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='540'){
$( "#539" ).removeClass( "show" ).addClass( "hide" );
$( "#540" ).removeClass( "hide" ).addClass( "show" );

}
else if(app_status=='541'){

$( "#539" ).removeClass( "show" ).addClass( "hide" );

$( "#540" ).removeClass( "show" ).addClass( "hide" );

$( "#541" ).removeClass( "hide" ).addClass( "show" );
}
else if(app_status=='542'){

$( "#539" ).removeClass( "show" ).addClass( "hide" );
$( "#540" ).removeClass( "show" ).addClass( "hide" );
$( "#541" ).removeClass( "show" ).addClass( "hide" );
$( "#543" ).removeClass( "show" ).addClass( "hide" );

$( "#542" ).removeClass( "hide" ).addClass( "show" );
}

else if(app_status=='543'){

$( "#539" ).removeClass( "show" ).addClass( "hide" );
$( "#540" ).removeClass( "show" ).addClass( "hide" );
$( "#541" ).removeClass( "show" ).addClass( "hide" );
$( "#542" ).removeClass( "show" ).addClass( "hide" );
$( "#543" ).removeClass( "hide" ).addClass( "show" );
}
